...
export default class MembersApi {
    ...
    */
    ...
    /**
     * Returns a list of Members. This assumes that members have first been uploaded via a POST request or web console
     * @param {String} memberRefId2 Unique reference identifier of the resource
     * @param {Object} opts Optional parameters
     * @param {Array.<String>} opts.memberRefId The unique reference identifiers of the resources
     * @param {Number} opts.limit Limit the returned total records found
     * @param {Number} opts.skip Skip the returned records found and return the next batch of records
     ...
     * data is of type: {@link module:model/MemberResponse}
     */
    getMembersByRefId(memberRefId2, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'memberRefId2' is set
      if (memberRefId2 === undefined || memberRefId2 === null) {
        throw new Error("Missing the required parameter 'memberRefId2' when calling getMembersByRefId");
      }

      let pathParams = {
        'memberRefId': memberRefId2
      };
      let queryParams = {
        'memberRefId': this.apiClient.buildCollectionParam(opts['memberRefId'], 'multi'),
        '_limit': opts['limit'],
        '_skip': opts['skip']
      };
      let headerParams = {

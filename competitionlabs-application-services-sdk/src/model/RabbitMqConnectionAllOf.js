...
class RabbitMqConnectionAllOf {
     ...
     */
    constructor(name, uri, virtualHost, port, userName, password, queueName, lastKnownStatus, lastKnownStatusCode, constraints) { 
        
        RabbitMqConnectionAllOf.initialize(this, name, uri, virtualHost, port, userName, password, queueName, lastKnownStatus, lastKnownStatusCode, constraints);
    }
     ...
     */
    static initialize(obj, name, uri, virtualHost, port, userName, password, queueName, lastKnownStatus, lastKnownStatusCode, constraints) { 
        obj['name'] = name;
        obj['uri'] = uri;

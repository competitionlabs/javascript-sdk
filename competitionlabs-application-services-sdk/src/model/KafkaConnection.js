...
class KafkaConnection {
    ...
    constructor(id, spaceName, created, objectType, name, brokers, groupId, topic, lastKnownStatus, lastKnownStatusCode) { 
        Connection.initialize(this, id, spaceName, created, objectType);ModelDefault.initialize(this, id, spaceName, created);OptParamModels.initialize(this);KafkaConnectionAllOf.initialize(this, name, brokers, groupId, topic, lastKnownStatus, lastKnownStatusCode);

...
class UpdateAchievementRequest {
     ...
     */
    constructor(id, name, icon, ruleSets, dependantOn, scheduling, achievementLiveStatus, constraints) { 
        UpdateModelDefault.initialize(this, id);UpdateOptParamModels.initialize(this);UpdateAchievementRequestAllOf.initialize(this, name, icon, ruleSets, dependantOn, scheduling, achievementLiveStatus, constraints);
        UpdateAchievementRequest.initialize(this, id, name, icon, ruleSets, dependantOn, scheduling, achievementLiveStatus, constraints);
    }
     ...
     */
    static initialize(obj, id, name, icon, ruleSets, dependantOn, scheduling, achievementLiveStatus, constraints) { 
        obj['id'] = id;
        obj['name'] = name;
        obj['icon'] = icon;

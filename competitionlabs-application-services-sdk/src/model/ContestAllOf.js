...
class ContestAllOf {
     ...
     */
    constructor(competitionId, row, name, round, roundType, entrantsFromContest, minNumberOfEntrants, ruleSets, scheduledStartDate, scheduledEndDate, status, statusCode, constraints) { 
        
        ContestAllOf.initialize(this, competitionId, row, name, round, roundType, entrantsFromContest, minNumberOfEntrants, ruleSets, scheduledStartDate, scheduledEndDate, status, statusCode, constraints);
    }
     ...
     */
    static initialize(obj, competitionId, row, name, round, roundType, entrantsFromContest, minNumberOfEntrants, ruleSets, scheduledStartDate, scheduledEndDate, status, statusCode, constraints) { 

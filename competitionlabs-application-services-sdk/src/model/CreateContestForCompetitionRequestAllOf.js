...
class CreateContestForCompetitionRequestAllOf {
    ...
    constructor(competitionId, row, round, name, roundType, minNumberOfEntrants, ruleSets, scheduledStartDate, scheduledEndDate, strategies, constraints) { 
        ...
        CreateContestForCompetitionRequestAllOf.initialize(this, competitionId, row, round, name, roundType, minNumberOfEntrants, ruleSets, scheduledStartDate, scheduledEndDate, strategies, constraints);
    }

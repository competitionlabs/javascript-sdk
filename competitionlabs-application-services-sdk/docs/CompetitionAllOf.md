# @CompetitionlabsApplicationServicesSdk.CompetitionAllOf
...
**isPublic** | **Boolean** | Is the event publicly exposed depending on the event model | 
**autoStart** | **Boolean** | Is the event publicly exposed depending on the event model | 

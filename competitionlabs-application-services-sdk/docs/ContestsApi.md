...
------------- | ------------- | -------------
[**createContests**](docs/ContestsApi.md#createContests) | **POST** /contests/{spaceName} | 
[**deleteContestsByQuery**](docs/ContestsApi.md#deleteContestsByQuery) | **POST** /contests/{spaceName}/delete | 
[**getChildrenOfContest**](docs/ContestsApi.md#getChildrenOfContest) | **GET** /contests/{spaceName}/{id}/children | 
[**getContests**](docs/ContestsApi.md#getContests) | **GET** /contests/{spaceName} | 
[**getContestsByQuery**](docs/ContestsApi.md#getContestsByQuery) | **POST** /contests/{spaceName}/query | 
[**getContestsLeaderboardById**](docs/ContestsApi.md#getContestsLeaderboardById) | **GET** /contests/{spaceName}/{id}/leaderboard | 
[**getContestsToClone**](docs/ContestsApi.md#getContestsToClone) | **GET** /contests/{spaceName}/{id}/clone | 
[**getListOfEntrantsForContest**](docs/ContestsApi.md#getListOfEntrantsForContest) | **GET** /contests/{spaceName}/{id}/entries | 
[**getParentsOfContest**](docs/ContestsApi.md#getParentsOfContest) | **GET** /contests/{spaceName}/{id}/parents | 
[**updateContest**](docs/ContestsApi.md#updateContest) | **PUT** /contests/{spaceName} | 
[**updateContestsState**](docs/ContestsApi.md#updateContestsState) | **PUT** /contests/{spaceName}/state | 
 ...
 **body** | [**CreateContestForCompetitionRequest**](docs/CreateContestForCompetitionRequest.md)| Create a Contests in the CompetitionLabs database | 
 ...
 **spaceName** | **String**| This is the space name which is linked to the account | 
 **X_API_KEY** | **String**| The admin API Key generated from CompetitionLabs back office | [optional] 
 **body** | [**QueryRequest**](docs/QueryRequest.md)| Delete Contests from CompetitionLabs database by unique Contest ID&#39;s or any other Post body parameters using the POST method | [optional] 
 ...
 **spaceName** | **String**| This is the space name which is linked to the account | 
 **X_API_KEY** | **String**| The admin API Key generated from CompetitionLabs back office | [optional] 
 **body** | [**QueryRequest**](docs/QueryRequest.md)| Retrieve Contests from CompetitionLabs database by unique Contest ID&#39;s or any other Post body parameters using the POST method | [optional] 
...
------------- | ------------- | ------------- | -------------
 **spaceName** | **String**| This is the space name which is linked to the account | 
 **body** | [**UpdateContestRequest**](docs/UpdateContestRequest.md)| Update a Contest in the CompetitionLabs database. * A Contests Id must exist in the CompetitionLabs database for update | 
 **X_API_KEY** | **String**| The admin API Key generated from CompetitionLabs back office | [optional] 
 ...
 **spaceName** | **String**| This is the space name which is linked to the account | 
 **X_API_KEY** | **String**| The admin API Key generated from CompetitionLabs back office | [optional] 
 **body** | [**[UpdateContestStateRequest]**](docs/UpdateContestStateRequest.md)| Updates the state of the Contest | [optional] 

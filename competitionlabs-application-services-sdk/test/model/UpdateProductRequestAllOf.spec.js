...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateProductRequestAllOf();
  });
  ...
  describe('UpdateProductRequestAllOf', function() {
    it('should create an instance of UpdateProductRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateProductRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateProductRequestAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.UpdateProductRequestAllOf();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateSqsConnectionRequest();
  });
  ...
  describe('CreateSqsConnectionRequest', function() {
    it('should create an instance of CreateSqsConnectionRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateSqsConnectionRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateSqsConnectionRequest);
    });
    ...
    it('should have the property objectType (base name: "objectType")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.CreateSqsConnectionRequest();

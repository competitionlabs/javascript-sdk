...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.QueryMultipleFields();
  });
  ...
  describe('QueryMultipleFields', function() {
    it('should create an instance of QueryMultipleFields', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.QueryMultipleFields();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.QueryMultipleFields);
    });
    ...
    it('should have the property queryFields (base name: "queryFields")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.QueryMultipleFields();

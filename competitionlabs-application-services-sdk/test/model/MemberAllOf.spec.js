...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.MemberAllOf();
  });
  ...
  describe('MemberAllOf', function() {
    it('should create an instance of MemberAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.MemberAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.MemberAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.MemberAllOf();

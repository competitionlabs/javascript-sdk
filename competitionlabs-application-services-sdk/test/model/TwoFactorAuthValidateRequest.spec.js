...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.TwoFactorAuthValidateRequest();
  });
  ...
  describe('TwoFactorAuthValidateRequest', function() {
    it('should create an instance of TwoFactorAuthValidateRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.TwoFactorAuthValidateRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.TwoFactorAuthValidateRequest);
    });
    ...
    it('should have the property secretKey (base name: "secretKey")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.TwoFactorAuthValidateRequest();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateWebhookRequest();
  });
  ...
  describe('CreateWebhookRequest', function() {
    it('should create an instance of CreateWebhookRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateWebhookRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateWebhookRequest);
    });

    it('should have the property customFields (base name: "customFields")', function() {
      // uncomment below and update the code to test the property customFields
      //var instance = new CompetitionLabsAdminServices.CreateWebhookRequest();

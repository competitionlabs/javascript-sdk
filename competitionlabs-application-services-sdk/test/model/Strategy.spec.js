...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Strategy();
  });
  ...
  describe('Strategy', function() {
    it('should create an instance of Strategy', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Strategy();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Strategy);
    });
    ...
    it('should have the property strategyType (base name: "strategyType")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.Strategy();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsJavascriptSdk.CompetitionAllOf();
  });
  ...
  describe('CompetitionAllOf', function() {
    it('should create an instance of CompetitionAllOf', function() {
      ...
      //var instane = new @CompetitionlabsJavascriptSdk.CompetitionAllOf();
      //expect(instance).to.be.a(@CompetitionlabsJavascriptSdk.CompetitionAllOf);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.CompetitionAllOf();
  });
  ...
  describe('CompetitionAllOf', function() {
    it('should create an instance of CompetitionAllOf', function() {
      ...
      //var instane = new CompetitionLabsApplicationServices.CompetitionAllOf();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.CompetitionAllOf);
    });
    ...
    it('should have the property competitionType (base name: "competitionType")', function() {
      ...
      //var instance = new CompetitionLabsApplicationServices.CompetitionAllOf();

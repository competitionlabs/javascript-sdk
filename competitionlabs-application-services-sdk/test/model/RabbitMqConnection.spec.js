...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.RabbitMqConnection();
  });
  ...
  describe('RabbitMqConnection', function() {
    it('should create an instance of RabbitMqConnection', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.RabbitMqConnection();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.RabbitMqConnection);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.RabbitMqConnection();

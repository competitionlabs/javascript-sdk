...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Webhook();
  });
  ...
  describe('Webhook', function() {
    it('should create an instance of Webhook', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Webhook();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Webhook);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.Webhook();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateWebhookRequest();
  });
  ...
  describe('UpdateWebhookRequest', function() {
    it('should create an instance of UpdateWebhookRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateWebhookRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateWebhookRequest);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.UpdateWebhookRequest();

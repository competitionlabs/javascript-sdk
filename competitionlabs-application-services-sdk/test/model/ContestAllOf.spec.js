...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.ContestAllOf();
  });
  ...
  describe('ContestAllOf', function() {
    it('should create an instance of ContestAllOf', function() {
      ...
      //var instane = new CompetitionLabsApplicationServices.ContestAllOf();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.ContestAllOf);
    });
    ...
    it('should have the property competitionId (base name: "competitionId")', function() {
      ...
      //var instance = new CompetitionLabsApplicationServices.ContestAllOf();

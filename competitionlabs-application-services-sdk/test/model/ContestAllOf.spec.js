...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.ContestAllOf();
  });
  ...
  describe('ContestAllOf', function() {
    it('should create an instance of ContestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.ContestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.ContestAllOf);
    });
    ...
    it('should have the property competitionId (base name: "competitionId")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.ContestAllOf();

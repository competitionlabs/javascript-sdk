...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsJavascriptSdk.ContestAllOf();
  });
  ...
  describe('ContestAllOf', function() {
    it('should create an instance of ContestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsJavascriptSdk.ContestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsJavascriptSdk.ContestAllOf);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UnitOfMeasureAllOf();
  });
  ...
  describe('UnitOfMeasureAllOf', function() {
    it('should create an instance of UnitOfMeasureAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UnitOfMeasureAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UnitOfMeasureAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.UnitOfMeasureAllOf();

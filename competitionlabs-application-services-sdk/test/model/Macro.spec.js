...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Macro();
  });
  ...
  describe('Macro', function() {
    it('should create an instance of Macro', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Macro();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Macro);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.Macro();

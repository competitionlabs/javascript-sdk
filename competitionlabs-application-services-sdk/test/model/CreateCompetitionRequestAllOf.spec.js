...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.CreateCompetitionRequestAllOf();
  });
  ...
  describe('CreateCompetitionRequestAllOf', function() {
    it('should create an instance of CreateCompetitionRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsApplicationServices.CreateCompetitionRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.CreateCompetitionRequestAllOf);
    });
    ...
    it('should have the property competitionType (base name: "competitionType")', function() {
      ...
      //var instance = new CompetitionLabsApplicationServices.CreateCompetitionRequestAllOf();

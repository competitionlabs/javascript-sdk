...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.SpaceAllOf();
  });
  ...
  describe('SpaceAllOf', function() {
    it('should create an instance of SpaceAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.SpaceAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.SpaceAllOf);
    });
    ...
    it('should have the property accountType (base name: "accountType")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.SpaceAllOf();

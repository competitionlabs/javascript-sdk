...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.RewardAllOf();
  });
  ...
  describe('RewardAllOf', function() {
    it('should create an instance of RewardAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.RewardAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.RewardAllOf);
    });
    ...
    it('should have the property entityType (base name: "entityType")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.RewardAllOf();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.RewardAllOf();
  });
  ...
  describe('RewardAllOf', function() {
    it('should create an instance of RewardAllOf', function() {
      ...
      //var instane = new CompetitionLabsApplicationServices.RewardAllOf();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.RewardAllOf);
    });
    ...
    it('should have the property entityType (base name: "entityType")', function() {
      ...
      //var instance = new CompetitionLabsApplicationServices.RewardAllOf();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.QuerySingle();
  });
  ...
  describe('QuerySingle', function() {
    it('should create an instance of QuerySingle', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.QuerySingle();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.QuerySingle);
    });
    ...
    it('should have the property queryField (base name: "queryField")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.QuerySingle();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Product();
  });
  ...
  describe('Product', function() {
    it('should create an instance of Product', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Product();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Product);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.Product();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.EventAllOf();
  });
  ...
  describe('EventAllOf', function() {
    it('should create an instance of EventAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.EventAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.EventAllOf);
    });
    ...
    it('should have the property memberId (base name: "memberId")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.EventAllOf();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateRabbitMqConnectionRequest();
  });
  ...
  describe('CreateRabbitMqConnectionRequest', function() {
    it('should create an instance of CreateRabbitMqConnectionRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateRabbitMqConnectionRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateRabbitMqConnectionRequest);
    });

    it('should have the property customFields (base name: "customFields")', function() {
      // uncomment below and update the code to test the property customFields
      //var instance = new CompetitionLabsAdminServices.CreateRabbitMqConnectionRequest();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.FileObject();
  });
  ...
  describe('FileObject', function() {
    it('should create an instance of FileObject', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.FileObject();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.FileObject);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.FileObject();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.ClaimAwardRequest();
  });
  ...
  describe('ClaimAwardRequest', function() {
    it('should create an instance of ClaimAwardRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.ClaimAwardRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.ClaimAwardRequest);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.ClaimAwardRequest();

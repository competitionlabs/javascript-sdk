...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CompetitionReduced();
  });
  ...
  describe('CompetitionReduced', function() {
    it('should create an instance of CompetitionReduced', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CompetitionReduced();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CompetitionReduced);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.CompetitionReduced();

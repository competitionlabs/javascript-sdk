...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.CreateRewardRequestAllOf();
  });
  ...
  describe('CreateRewardRequestAllOf', function() {
    it('should create an instance of CreateRewardRequestAllOf', function() {
      // uncomment below and update the code to test CreateRewardRequestAllOf
      //var instane = new CompetitionLabsApplicationServices.CreateRewardRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.CreateRewardRequestAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsApplicationServices.CreateRewardRequestAllOf();

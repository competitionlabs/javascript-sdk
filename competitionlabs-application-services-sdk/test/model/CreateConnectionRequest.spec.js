...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateConnectionRequest();
  });
  ...
  describe('CreateConnectionRequest', function() {
    it('should create an instance of CreateConnectionRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateConnectionRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateConnectionRequest);
    });
    ...
    it('should have the property objectType (base name: "objectType")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.CreateConnectionRequest();

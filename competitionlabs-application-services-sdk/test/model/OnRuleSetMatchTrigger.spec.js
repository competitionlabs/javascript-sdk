...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.OnRuleSetMatchTrigger();
  });
  ...
  describe('OnRuleSetMatchTrigger', function() {
    it('should create an instance of OnRuleSetMatchTrigger', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.OnRuleSetMatchTrigger();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.OnRuleSetMatchTrigger);
    });

    it('should have the property constraints (base name: "constraints")', function() {
      // uncomment below and update the code to test the property constraints
      //var instance = new CompetitionLabsAdminServices.OnRuleSetMatchTrigger();

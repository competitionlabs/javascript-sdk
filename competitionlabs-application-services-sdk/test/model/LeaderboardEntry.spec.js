...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.LeaderboardEntry();
  });
  ...
  describe('LeaderboardEntry', function() {
    it('should create an instance of LeaderboardEntry', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.LeaderboardEntry();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.LeaderboardEntry);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.LeaderboardEntry();

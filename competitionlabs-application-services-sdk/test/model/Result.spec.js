...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Result();
  });
  ...
  describe('Result', function() {
    it('should create an instance of Result', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Result();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Result);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.Result();

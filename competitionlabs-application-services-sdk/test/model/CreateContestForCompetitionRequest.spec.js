...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.CreateContestForCompetitionRequest();
  });
  ...
  describe('CreateContestForCompetitionRequest', function() {
    it('should create an instance of CreateContestForCompetitionRequest', function() {
      ...
      //var instane = new CompetitionLabsApplicationServices.CreateContestForCompetitionRequest();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.CreateContestForCompetitionRequest);
    });

    it('should have the property customFields (base name: "customFields")', function() {
      // uncomment below and update the code to test the property customFields
      //var instance = new CompetitionLabsApplicationServices.CreateContestForCompetitionRequest();

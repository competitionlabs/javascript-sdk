...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsJavascriptSdk.CreateContestForCompetitionRequest();
  });
  ...
  describe('CreateContestForCompetitionRequest', function() {
    it('should create an instance of CreateContestForCompetitionRequest', function() {
      ...
      //var instane = new @CompetitionlabsJavascriptSdk.CreateContestForCompetitionRequest();
      //expect(instance).to.be.a(@CompetitionlabsJavascriptSdk.CreateContestForCompetitionRequest);
    });

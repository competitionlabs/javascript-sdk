...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.AttachmentResponse();
  });
  ...
  describe('AttachmentResponse', function() {
    it('should create an instance of AttachmentResponse', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.AttachmentResponse();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.AttachmentResponse);
    });

    it('should have the property meta (base name: "meta")', function() {
      // uncomment below and update the code to test the property meta
      //var instance = new CompetitionLabsAdminServices.AttachmentResponse();

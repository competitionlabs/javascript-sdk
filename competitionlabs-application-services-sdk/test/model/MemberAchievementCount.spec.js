...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.MemberAchievementCount();
  });
  ...
  describe('MemberAchievementCount', function() {
    it('should create an instance of MemberAchievementCount', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.MemberAchievementCount();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.MemberAchievementCount);
    });

    it('should have the property entityId (base name: "entityId")', function() {
      // uncomment below and update the code to test the property entityId
      //var instance = new CompetitionLabsAdminServices.MemberAchievementCount();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.SqsConnectionAllOf();
  });
  ...
  describe('SqsConnectionAllOf', function() {
    it('should create an instance of SqsConnectionAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.SqsConnectionAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.SqsConnectionAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.SqsConnectionAllOf();

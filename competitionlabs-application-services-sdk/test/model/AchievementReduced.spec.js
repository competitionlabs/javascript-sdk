...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.AchievementReduced();
  });
  ...
  describe('AchievementReduced', function() {
    it('should create an instance of AchievementReduced', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.AchievementReduced();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.AchievementReduced);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.AchievementReduced();

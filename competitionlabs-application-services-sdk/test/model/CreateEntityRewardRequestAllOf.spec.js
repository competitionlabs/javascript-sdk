...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateEntityRewardRequestAllOf();
  });
  ...
  describe('CreateEntityRewardRequestAllOf', function() {
    it('should create an instance of CreateEntityRewardRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateEntityRewardRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateEntityRewardRequestAllOf);
    });
    ...
    it('should have the property entityType (base name: "entityType")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.CreateEntityRewardRequestAllOf();

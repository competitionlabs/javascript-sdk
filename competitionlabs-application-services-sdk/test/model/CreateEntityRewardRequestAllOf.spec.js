...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.CreateEntityRewardRequestAllOf();
  });
  ...
  describe('CreateEntityRewardRequestAllOf', function() {
    it('should create an instance of CreateEntityRewardRequestAllOf', function() {
      // uncomment below and update the code to test CreateEntityRewardRequestAllOf
      //var instane = new CompetitionLabsApplicationServices.CreateEntityRewardRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.CreateEntityRewardRequestAllOf);
    });
    ...
    it('should have the property entityType (base name: "entityType")', function() {
      ...
      //var instance = new CompetitionLabsApplicationServices.CreateEntityRewardRequestAllOf();

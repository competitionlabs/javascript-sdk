...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.RuleSetAllOf();
  });
  ...
  describe('RuleSetAllOf', function() {
    it('should create an instance of RuleSetAllOf', function() {
      ...
      //var instane = new CompetitionLabsApplicationServices.RuleSetAllOf();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.RuleSetAllOf);
    });

    it('should have the property priority (base name: "priority")', function() {
      // uncomment below and update the code to test the property priority
      //var instance = new CompetitionLabsApplicationServices.RuleSetAllOf();

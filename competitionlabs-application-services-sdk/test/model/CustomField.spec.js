...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CustomField();
  });
  ...
  describe('CustomField', function() {
    it('should create an instance of CustomField', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CustomField();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CustomField);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.CustomField();

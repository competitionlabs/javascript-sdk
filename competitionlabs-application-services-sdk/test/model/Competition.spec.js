...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Competition();
  });
  ...
  describe('Competition', function() {
    it('should create an instance of Competition', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Competition();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Competition);
    });

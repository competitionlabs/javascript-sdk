...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.Competition();
  });
  ...
  describe('Competition', function() {
    it('should create an instance of Competition', function() {
      ...
      //var instane = new CompetitionLabsApplicationServices.Competition();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.Competition);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsApplicationServices.Competition();

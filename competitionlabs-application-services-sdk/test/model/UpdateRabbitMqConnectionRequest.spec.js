...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateRabbitMqConnectionRequest();
  });
  ...
  describe('UpdateRabbitMqConnectionRequest', function() {
    it('should create an instance of UpdateRabbitMqConnectionRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateRabbitMqConnectionRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateRabbitMqConnectionRequest);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.UpdateRabbitMqConnectionRequest();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.ContestReduced();
  });
  ...
  describe('ContestReduced', function() {
    it('should create an instance of ContestReduced', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.ContestReduced();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.ContestReduced);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.ContestReduced();

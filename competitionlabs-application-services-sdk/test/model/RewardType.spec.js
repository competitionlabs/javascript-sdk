...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.RewardType();
  });
  ...
  describe('RewardType', function() {
    it('should create an instance of RewardType', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.RewardType();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.RewardType);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.RewardType();

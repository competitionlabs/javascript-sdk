...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateApiKeyRequestAllOf();
  });
  ...
  describe('UpdateApiKeyRequestAllOf', function() {
    it('should create an instance of UpdateApiKeyRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateApiKeyRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateApiKeyRequestAllOf);
    });

    it('should have the property description (base name: "description")', function() {
      // uncomment below and update the code to test the property description
      //var instance = new CompetitionLabsAdminServices.UpdateApiKeyRequestAllOf();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.RuleDescriptor();
  });
  ...
  describe('RuleDescriptor', function() {
    it('should create an instance of RuleDescriptor', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.RuleDescriptor();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.RuleDescriptor);
    });
    ...
    it('should have the property ruleScope (base name: "ruleScope")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.RuleDescriptor();

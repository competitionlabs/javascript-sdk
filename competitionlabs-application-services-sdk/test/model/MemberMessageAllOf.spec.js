...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.MemberMessageAllOf();
  });
  ...
  describe('MemberMessageAllOf', function() {
    it('should create an instance of MemberMessageAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.MemberMessageAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.MemberMessageAllOf);
    });
    ...
    it('should have the property eventRefType (base name: "eventRefType")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.MemberMessageAllOf();

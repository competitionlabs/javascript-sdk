...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateRewardTypeRequest();
  });
  ...
  describe('UpdateRewardTypeRequest', function() {
    it('should create an instance of UpdateRewardTypeRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateRewardTypeRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateRewardTypeRequest);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.UpdateRewardTypeRequest();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.KafkaConnectionAllOf();
  });
  ...
  describe('KafkaConnectionAllOf', function() {
    it('should create an instance of KafkaConnectionAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.KafkaConnectionAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.KafkaConnectionAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.KafkaConnectionAllOf();

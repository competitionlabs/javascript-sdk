...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.FactDefault();
  });
  ...
  describe('FactDefault', function() {
    it('should create an instance of FactDefault', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.FactDefault();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.FactDefault);
    });
    ...
    it('should have the property operators (base name: "operators")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.FactDefault();

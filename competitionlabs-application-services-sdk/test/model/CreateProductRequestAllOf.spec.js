...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.CreateProductRequestAllOf();
  });
  ...
  describe('CreateProductRequestAllOf', function() {
    it('should create an instance of CreateProductRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsApplicationServices.CreateProductRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.CreateProductRequestAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsApplicationServices.CreateProductRequestAllOf();

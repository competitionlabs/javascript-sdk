...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateProductRequestAllOf();
  });
  ...
  describe('CreateProductRequestAllOf', function() {
    it('should create an instance of CreateProductRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateProductRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateProductRequestAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.CreateProductRequestAllOf();

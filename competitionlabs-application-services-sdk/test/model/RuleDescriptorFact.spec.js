...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.RuleDescriptorFact();
  });
  ...
  describe('RuleDescriptorFact', function() {
    it('should create an instance of RuleDescriptorFact', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.RuleDescriptorFact();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.RuleDescriptorFact);
    });
    ...
    it('should have the property operators (base name: "operators")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.RuleDescriptorFact();

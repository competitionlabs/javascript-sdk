...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.MetaBasic();
  });
  ...
  describe('MetaBasic', function() {
    it('should create an instance of MetaBasic', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.MetaBasic();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.MetaBasic);
    });
    ...
    it('should have the property objectType (base name: "objectType")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.MetaBasic();

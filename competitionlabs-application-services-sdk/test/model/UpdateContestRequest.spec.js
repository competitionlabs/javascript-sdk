...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateContestRequest();
  });
  ...
  describe('UpdateContestRequest', function() {
    it('should create an instance of UpdateContestRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateContestRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateContestRequest);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.UpdateContestRequest();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.UpdateContestRequest();
  });
  ...
  describe('UpdateContestRequest', function() {
    it('should create an instance of UpdateContestRequest', function() {
      // uncomment below and update the code to test UpdateContestRequest
      //var instane = new CompetitionLabsApplicationServices.UpdateContestRequest();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.UpdateContestRequest);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsApplicationServices.UpdateContestRequest();

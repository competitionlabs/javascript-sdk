...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsJavascriptSdk.UpdateContestRequest();
  });
  ...
  describe('UpdateContestRequest', function() {
    it('should create an instance of UpdateContestRequest', function() {
      ...
      //var instane = new @CompetitionlabsJavascriptSdk.UpdateContestRequest();
      //expect(instance).to.be.a(@CompetitionlabsJavascriptSdk.UpdateContestRequest);
    });

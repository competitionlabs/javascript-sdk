...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateMemberRequest();
  });
  ...
  describe('CreateMemberRequest', function() {
    it('should create an instance of CreateMemberRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateMemberRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateMemberRequest);
    });

    it('should have the property customFields (base name: "customFields")', function() {
      // uncomment below and update the code to test the property customFields
      //var instance = new CompetitionLabsAdminServices.CreateMemberRequest();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.RewardTypeAllOf();
  });
  ...
  describe('RewardTypeAllOf', function() {
    it('should create an instance of RewardTypeAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.RewardTypeAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.RewardTypeAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.RewardTypeAllOf();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsJavascriptSdk.MemberAward();
  });
  ...
  describe('MemberAward', function() {
    it('should create an instance of MemberAward', function() {
      ...
      //var instane = new @CompetitionlabsJavascriptSdk.MemberAward();
      //expect(instance).to.be.a(@CompetitionlabsJavascriptSdk.MemberAward);
    });

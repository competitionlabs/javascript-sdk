...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.MemberAward();
  });
  ...
  describe('MemberAward', function() {
    it('should create an instance of MemberAward', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.MemberAward();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.MemberAward);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.MemberAward();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateEntityRewardRequest();
  });
  ...
  describe('CreateEntityRewardRequest', function() {
    it('should create an instance of CreateEntityRewardRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateEntityRewardRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateEntityRewardRequest);
    });

    it('should have the property customFields (base name: "customFields")', function() {
      // uncomment below and update the code to test the property customFields
      //var instance = new CompetitionLabsAdminServices.CreateEntityRewardRequest();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.ErrorDetail();
  });
  ...
  describe('ErrorDetail', function() {
    it('should create an instance of ErrorDetail', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.ErrorDetail();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.ErrorDetail);
    });
    ...
    it('should have the property modelId (base name: "modelId")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.ErrorDetail();

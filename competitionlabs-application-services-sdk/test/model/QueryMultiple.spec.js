...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.QueryMultiple();
  });
  ...
  describe('QueryMultiple', function() {
    it('should create an instance of QueryMultiple', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.QueryMultiple();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.QueryMultiple);
    });
    ...
    it('should have the property queryField (base name: "queryField")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.QueryMultiple();

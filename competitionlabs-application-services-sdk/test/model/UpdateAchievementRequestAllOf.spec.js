...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.UpdateAchievementRequestAllOf();
  });
  ...
  describe('UpdateAchievementRequestAllOf', function() {
    it('should create an instance of UpdateAchievementRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsApplicationServices.UpdateAchievementRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.UpdateAchievementRequestAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsApplicationServices.UpdateAchievementRequestAllOf();

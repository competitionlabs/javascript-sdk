...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateUnitOfMeasureRequestAllOf();
  });
  ...
  describe('UpdateUnitOfMeasureRequestAllOf', function() {
    it('should create an instance of UpdateUnitOfMeasureRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateUnitOfMeasureRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateUnitOfMeasureRequestAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.UpdateUnitOfMeasureRequestAllOf();

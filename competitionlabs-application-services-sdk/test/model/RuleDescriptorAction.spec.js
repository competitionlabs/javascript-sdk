...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.RuleDescriptorAction();
  });
  ...
  describe('RuleDescriptorAction', function() {
    it('should create an instance of RuleDescriptorAction', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.RuleDescriptorAction();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.RuleDescriptorAction);
    });

    it('should have the property constraints (base name: "constraints")', function() {
      // uncomment below and update the code to test the property constraints
      //var instance = new CompetitionLabsAdminServices.RuleDescriptorAction();

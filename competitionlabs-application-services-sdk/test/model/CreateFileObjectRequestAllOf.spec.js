...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.CreateFileObjectRequestAllOf();
  });
  ...
  describe('CreateFileObjectRequestAllOf', function() {
    it('should create an instance of CreateFileObjectRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsApplicationServices.CreateFileObjectRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.CreateFileObjectRequestAllOf);
    });
    ...
    it('should have the property repositoryId (base name: "repositoryId")', function() {
      ...
      //var instance = new CompetitionLabsApplicationServices.CreateFileObjectRequestAllOf();

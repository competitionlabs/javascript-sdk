...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateFileObjectRequestAllOf();
  });
  ...
  describe('CreateFileObjectRequestAllOf', function() {
    it('should create an instance of CreateFileObjectRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateFileObjectRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateFileObjectRequestAllOf);
    });
    ...
    it('should have the property repositoryId (base name: "repositoryId")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.CreateFileObjectRequestAllOf();

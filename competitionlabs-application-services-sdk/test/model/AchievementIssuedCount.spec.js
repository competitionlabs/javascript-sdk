...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.AchievementIssuedCount();
  });
  ...
  describe('AchievementIssuedCount', function() {
    it('should create an instance of AchievementIssuedCount', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.AchievementIssuedCount();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.AchievementIssuedCount);
    });

    it('should have the property entityId (base name: "entityId")', function() {
      // uncomment below and update the code to test the property entityId
      //var instance = new CompetitionLabsAdminServices.AchievementIssuedCount();

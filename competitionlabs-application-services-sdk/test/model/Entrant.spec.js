...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Entrant();
  });
  ...
  describe('Entrant', function() {
    it('should create an instance of Entrant', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Entrant();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Entrant);
    });
    ...
    it('should have the property entrantAction (base name: "entrantAction")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.Entrant();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateAchievementRequest();
  });
  ...
  describe('CreateAchievementRequest', function() {
    it('should create an instance of CreateAchievementRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateAchievementRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateAchievementRequest);
    });

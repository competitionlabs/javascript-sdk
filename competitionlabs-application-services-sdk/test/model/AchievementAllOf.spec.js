...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.AchievementAllOf();
  });
  ...
  describe('AchievementAllOf', function() {
    it('should create an instance of AchievementAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.AchievementAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.AchievementAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.AchievementAllOf();

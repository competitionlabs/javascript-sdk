...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CustomFieldResponse();
  });
  ...
  describe('CustomFieldResponse', function() {
    it('should create an instance of CustomFieldResponse', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CustomFieldResponse();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CustomFieldResponse);
    });

    it('should have the property meta (base name: "meta")', function() {
      // uncomment below and update the code to test the property meta
      //var instance = new CompetitionLabsAdminServices.CustomFieldResponse();

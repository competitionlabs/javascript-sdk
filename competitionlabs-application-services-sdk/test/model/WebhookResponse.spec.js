...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.WebhookResponse();
  });
  ...
  describe('WebhookResponse', function() {
    it('should create an instance of WebhookResponse', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.WebhookResponse();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.WebhookResponse);
    });

    it('should have the property meta (base name: "meta")', function() {
      // uncomment below and update the code to test the property meta
      //var instance = new CompetitionLabsAdminServices.WebhookResponse();

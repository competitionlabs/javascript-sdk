...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateFileObjectRequestAllOf();
  });
  ...
  describe('UpdateFileObjectRequestAllOf', function() {
    it('should create an instance of UpdateFileObjectRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateFileObjectRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateFileObjectRequestAllOf);
    });
    ...
    it('should have the property repositoryId (base name: "repositoryId")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.UpdateFileObjectRequestAllOf();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.CreateMessageRequestAllOf();
  });
  ...
  describe('CreateMessageRequestAllOf', function() {
    it('should create an instance of CreateMessageRequestAllOf', function() {
      // uncomment below and update the code to test CreateMessageRequestAllOf
      //var instane = new CompetitionLabsApplicationServices.CreateMessageRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.CreateMessageRequestAllOf);
    });
    ...
    it('should have the property memberGroup (base name: "memberGroup")', function() {
      ...
      //var instance = new CompetitionLabsApplicationServices.CreateMessageRequestAllOf();

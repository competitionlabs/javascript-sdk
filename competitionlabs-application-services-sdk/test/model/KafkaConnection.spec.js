...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.KafkaConnection();
  });
  ...
  describe('KafkaConnection', function() {
    it('should create an instance of KafkaConnection', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.KafkaConnection();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.KafkaConnection);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.KafkaConnection();

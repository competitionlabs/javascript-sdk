...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.EntrantRequest();
  });
  ...
  describe('EntrantRequest', function() {
    it('should create an instance of EntrantRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.EntrantRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.EntrantRequest);
    });
    ...
    it('should have the property memberId (base name: "memberId")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.EntrantRequest();

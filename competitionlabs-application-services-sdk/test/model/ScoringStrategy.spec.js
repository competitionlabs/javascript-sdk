...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.ScoringStrategy();
  });
  ...
  describe('ScoringStrategy', function() {
    it('should create an instance of ScoringStrategy', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.ScoringStrategy();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.ScoringStrategy);
    });
    ...
    it('should have the property limitUpdatesTo (base name: "limitUpdatesTo")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.ScoringStrategy();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateSqsConnectionRequest();
  });
  ...
  describe('UpdateSqsConnectionRequest', function() {
    it('should create an instance of UpdateSqsConnectionRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateSqsConnectionRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateSqsConnectionRequest);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.UpdateSqsConnectionRequest();

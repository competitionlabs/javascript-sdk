...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateProductRequest();
  });
  ...
  describe('CreateProductRequest', function() {
    it('should create an instance of CreateProductRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateProductRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateProductRequest);
    });

    it('should have the property customFields (base name: "customFields")', function() {
      // uncomment below and update the code to test the property customFields
      //var instance = new CompetitionLabsAdminServices.CreateProductRequest();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.RewardTypeReduced();
  });
  ...
  describe('RewardTypeReduced', function() {
    it('should create an instance of RewardTypeReduced', function() {
      ...
      //var instane = new CompetitionLabsApplicationServices.RewardTypeReduced();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.RewardTypeReduced);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsApplicationServices.RewardTypeReduced();

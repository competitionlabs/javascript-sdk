...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateCustomFieldRequestAllOf();
  });
  ...
  describe('UpdateCustomFieldRequestAllOf', function() {
    it('should create an instance of UpdateCustomFieldRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateCustomFieldRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateCustomFieldRequestAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.UpdateCustomFieldRequestAllOf();

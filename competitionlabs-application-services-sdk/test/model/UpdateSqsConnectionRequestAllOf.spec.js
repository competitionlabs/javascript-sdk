...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsJavascriptSdk.UpdateSqsConnectionRequestAllOf();
  });
  ...
  describe('UpdateSqsConnectionRequestAllOf', function() {
    it('should create an instance of UpdateSqsConnectionRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsJavascriptSdk.UpdateSqsConnectionRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsJavascriptSdk.UpdateSqsConnectionRequestAllOf);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateSqsConnectionRequestAllOf();
  });
  ...
  describe('UpdateSqsConnectionRequestAllOf', function() {
    it('should create an instance of UpdateSqsConnectionRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateSqsConnectionRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateSqsConnectionRequestAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.UpdateSqsConnectionRequestAllOf();

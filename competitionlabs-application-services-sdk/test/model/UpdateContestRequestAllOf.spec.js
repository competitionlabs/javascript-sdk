...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateContestRequestAllOf();
  });
  ...
  describe('UpdateContestRequestAllOf', function() {
    it('should create an instance of UpdateContestRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateContestRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateContestRequestAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.UpdateContestRequestAllOf();

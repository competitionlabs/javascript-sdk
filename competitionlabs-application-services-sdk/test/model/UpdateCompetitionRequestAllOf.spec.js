...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateCompetitionRequestAllOf();
  });
  ...
  describe('UpdateCompetitionRequestAllOf', function() {
    it('should create an instance of UpdateCompetitionRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateCompetitionRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateCompetitionRequestAllOf);
    });
    ...
    it('should have the property competitionType (base name: "competitionType")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.UpdateCompetitionRequestAllOf();

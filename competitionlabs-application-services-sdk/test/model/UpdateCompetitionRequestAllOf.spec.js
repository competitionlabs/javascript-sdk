...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsJavascriptSdk.UpdateCompetitionRequestAllOf();
  });
  ...
  describe('UpdateCompetitionRequestAllOf', function() {
    it('should create an instance of UpdateCompetitionRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsJavascriptSdk.UpdateCompetitionRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsJavascriptSdk.UpdateCompetitionRequestAllOf);
    });

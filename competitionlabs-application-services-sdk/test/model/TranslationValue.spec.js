...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.TranslationValue();
  });
  ...
  describe('TranslationValue', function() {
    it('should create an instance of TranslationValue', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.TranslationValue();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.TranslationValue);
    });

    it('should have the property key (base name: "key")', function() {
      // uncomment below and update the code to test the property key
      //var instance = new CompetitionLabsAdminServices.TranslationValue();

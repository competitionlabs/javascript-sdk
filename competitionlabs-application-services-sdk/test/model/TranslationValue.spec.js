...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.TranslationValue();
  });
  ...
  describe('TranslationValue', function() {
    it('should create an instance of TranslationValue', function() {
      ...
      //var instane = new CompetitionLabsApplicationServices.TranslationValue();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.TranslationValue);
    });

    it('should have the property key (base name: "key")', function() {
      // uncomment below and update the code to test the property key
      //var instance = new CompetitionLabsApplicationServices.TranslationValue();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Reward();
  });
  ...
  describe('Reward', function() {
    it('should create an instance of Reward', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Reward();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Reward);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.Reward();

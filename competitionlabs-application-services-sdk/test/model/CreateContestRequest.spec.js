...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.CreateContestRequest();
  });
  ...
  describe('CreateContestRequest', function() {
    it('should create an instance of CreateContestRequest', function() {
      // uncomment below and update the code to test CreateContestRequest
      //var instane = new CompetitionLabsApplicationServices.CreateContestRequest();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.CreateContestRequest);
    });

    it('should have the property customFields (base name: "customFields")', function() {
      // uncomment below and update the code to test the property customFields
      //var instance = new CompetitionLabsApplicationServices.CreateContestRequest();

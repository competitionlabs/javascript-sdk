...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateContestRequest();
  });
  ...
  describe('CreateContestRequest', function() {
    it('should create an instance of CreateContestRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateContestRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateContestRequest);
    });

    it('should have the property customFields (base name: "customFields")', function() {
      // uncomment below and update the code to test the property customFields
      //var instance = new CompetitionLabsAdminServices.CreateContestRequest();

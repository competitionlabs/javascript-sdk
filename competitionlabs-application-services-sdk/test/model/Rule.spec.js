...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Rule();
  });
  ...
  describe('Rule', function() {
    it('should create an instance of Rule', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Rule();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Rule);
    });

    it('should have the property fact (base name: "fact")', function() {
      // uncomment below and update the code to test the property fact
      //var instance = new CompetitionLabsAdminServices.Rule();

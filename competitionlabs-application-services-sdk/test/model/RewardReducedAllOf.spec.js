...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.RewardReducedAllOf();
  });
  ...
  describe('RewardReducedAllOf', function() {
    it('should create an instance of RewardReducedAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.RewardReducedAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.RewardReducedAllOf);
    });
    ...
    it('should have the property rewardRank (base name: "rewardRank")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.RewardReducedAllOf();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateCompetitionRequest();
  });
  ...
  describe('UpdateCompetitionRequest', function() {
    it('should create an instance of UpdateCompetitionRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateCompetitionRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateCompetitionRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateContestStateRequest();
  });
  ...
  describe('UpdateContestStateRequest', function() {
    it('should create an instance of UpdateContestStateRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateContestStateRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateContestStateRequest);
    });
    ...
    it('should have the property contestId (base name: "contestId")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.UpdateContestStateRequest();

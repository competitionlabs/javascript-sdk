...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.ProductReducedAllOf();
  });
  ...
  describe('ProductReducedAllOf', function() {
    it('should create an instance of ProductReducedAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.ProductReducedAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.ProductReducedAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.ProductReducedAllOf();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.ContestReducedAllOf();
  });
  ...
  describe('ContestReducedAllOf', function() {
    it('should create an instance of ContestReducedAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.ContestReducedAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.ContestReducedAllOf);
    });
    ...
    it('should have the property competitionId (base name: "competitionId")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.ContestReducedAllOf();

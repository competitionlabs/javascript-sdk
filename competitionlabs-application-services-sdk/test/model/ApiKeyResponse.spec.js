...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.ApiKeyResponse();
  });
  ...
  describe('ApiKeyResponse', function() {
    it('should create an instance of ApiKeyResponse', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.ApiKeyResponse();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.ApiKeyResponse);
    });

    it('should have the property meta (base name: "meta")', function() {
      // uncomment below and update the code to test the property meta
      //var instance = new CompetitionLabsAdminServices.ApiKeyResponse();

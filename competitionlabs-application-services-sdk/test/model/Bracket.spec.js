...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Bracket();
  });
  ...
  describe('Bracket', function() {
    it('should create an instance of Bracket', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Bracket();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Bracket);
    });
    ...
    it('should have the property rounds (base name: "rounds")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.Bracket();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsJavascriptSdk.UpdateRepositoryRequest();
  });
  ...
  describe('UpdateRepositoryRequest', function() {
    it('should create an instance of UpdateRepositoryRequest', function() {
      ...
      //var instane = new @CompetitionlabsJavascriptSdk.UpdateRepositoryRequest();
      //expect(instance).to.be.a(@CompetitionlabsJavascriptSdk.UpdateRepositoryRequest);
    });

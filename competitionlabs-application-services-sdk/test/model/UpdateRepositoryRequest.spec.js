...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateRepositoryRequest();
  });
  ...
  describe('UpdateRepositoryRequest', function() {
    it('should create an instance of UpdateRepositoryRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateRepositoryRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateRepositoryRequest);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.UpdateRepositoryRequest();

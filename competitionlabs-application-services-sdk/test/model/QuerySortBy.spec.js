...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.QuerySortBy();
  });
  ...
  describe('QuerySortBy', function() {
    it('should create an instance of QuerySortBy', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.QuerySortBy();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.QuerySortBy);
    });
    ...
    it('should have the property queryField (base name: "queryField")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.QuerySortBy();

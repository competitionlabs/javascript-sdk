...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.ApiKey();
  });
  ...
  describe('ApiKey', function() {
    it('should create an instance of ApiKey', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.ApiKey();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.ApiKey);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.ApiKey();

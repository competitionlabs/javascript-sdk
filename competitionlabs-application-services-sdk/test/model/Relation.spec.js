...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Relation();
  });
  ...
  describe('Relation', function() {
    it('should create an instance of Relation', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Relation();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Relation);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.Relation();

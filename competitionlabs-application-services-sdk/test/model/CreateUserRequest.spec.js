...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateUserRequest();
  });
  ...
  describe('CreateUserRequest', function() {
    it('should create an instance of CreateUserRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateUserRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateUserRequest);
    });

    it('should have the property customFields (base name: "customFields")', function() {
      // uncomment below and update the code to test the property customFields
      //var instance = new CompetitionLabsAdminServices.CreateUserRequest();

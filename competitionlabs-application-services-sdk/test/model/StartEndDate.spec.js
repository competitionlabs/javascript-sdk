...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.StartEndDate();
  });
  ...
  describe('StartEndDate', function() {
    it('should create an instance of StartEndDate', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.StartEndDate();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.StartEndDate);
    });

    it('should have the property start (base name: "start")', function() {
      // uncomment below and update the code to test the property start
      //var instance = new CompetitionLabsAdminServices.StartEndDate();

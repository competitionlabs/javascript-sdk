...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateRabbitMqConnectionRequestAllOf();
  });
  ...
  describe('UpdateRabbitMqConnectionRequestAllOf', function() {
    it('should create an instance of UpdateRabbitMqConnectionRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateRabbitMqConnectionRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateRabbitMqConnectionRequestAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.UpdateRabbitMqConnectionRequestAllOf();

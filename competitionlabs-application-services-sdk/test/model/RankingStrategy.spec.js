...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.RankingStrategy();
  });
  ...
  describe('RankingStrategy', function() {
    it('should create an instance of RankingStrategy', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.RankingStrategy();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.RankingStrategy);
    });

    it('should have the property constraints (base name: "constraints")', function() {
      // uncomment below and update the code to test the property constraints
      //var instance = new CompetitionLabsAdminServices.RankingStrategy();

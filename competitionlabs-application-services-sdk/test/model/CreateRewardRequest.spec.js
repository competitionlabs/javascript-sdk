...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateRewardRequest();
  });
  ...
  describe('CreateRewardRequest', function() {
    it('should create an instance of CreateRewardRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateRewardRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateRewardRequest);
    });

    it('should have the property customFields (base name: "customFields")', function() {
      // uncomment below and update the code to test the property customFields
      //var instance = new CompetitionLabsAdminServices.CreateRewardRequest();

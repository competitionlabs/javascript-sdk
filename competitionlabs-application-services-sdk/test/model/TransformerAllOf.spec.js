...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.TransformerAllOf();
  });
  ...
  describe('TransformerAllOf', function() {
    it('should create an instance of TransformerAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.TransformerAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.TransformerAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.TransformerAllOf();

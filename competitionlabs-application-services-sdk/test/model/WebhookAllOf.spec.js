...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.WebhookAllOf();
  });
  ...
  describe('WebhookAllOf', function() {
    it('should create an instance of WebhookAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.WebhookAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.WebhookAllOf);
    });
    ...
    it('should have the property postToUrl (base name: "postToUrl")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.WebhookAllOf();

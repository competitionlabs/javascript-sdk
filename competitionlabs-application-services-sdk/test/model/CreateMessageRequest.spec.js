...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateMessageRequest();
  });
  ...
  describe('CreateMessageRequest', function() {
    it('should create an instance of CreateMessageRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateMessageRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateMessageRequest);
    });

    it('should have the property customFields (base name: "customFields")', function() {
      // uncomment below and update the code to test the property customFields
      //var instance = new CompetitionLabsAdminServices.CreateMessageRequest();

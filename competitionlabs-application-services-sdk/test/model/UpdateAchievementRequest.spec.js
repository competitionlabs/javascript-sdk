...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateAchievementRequest();
  });
  ...
  describe('UpdateAchievementRequest', function() {
    it('should create an instance of UpdateAchievementRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateAchievementRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateAchievementRequest);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.UpdateAchievementRequest();

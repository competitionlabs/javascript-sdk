...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.MemberAwardAllOf();
  });
  ...
  describe('MemberAwardAllOf', function() {
    it('should create an instance of MemberAwardAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.MemberAwardAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.MemberAwardAllOf);
    });
    ...
    it('should have the property rewardId (base name: "rewardId")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.MemberAwardAllOf();

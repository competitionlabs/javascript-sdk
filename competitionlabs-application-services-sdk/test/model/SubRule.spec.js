...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.SubRule();
  });
  ...
  describe('SubRule', function() {
    it('should create an instance of SubRule', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.SubRule();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.SubRule);
    });

    it('should have the property fact (base name: "fact")', function() {
      // uncomment below and update the code to test the property fact
      //var instance = new CompetitionLabsAdminServices.SubRule();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateContestRequestAllOf();
  });
  ...
  describe('CreateContestRequestAllOf', function() {
    it('should create an instance of CreateContestRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateContestRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateContestRequestAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.CreateContestRequestAllOf();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.CreateCompetitionRequest();
  });
  ...
  describe('CreateCompetitionRequest', function() {
    it('should create an instance of CreateCompetitionRequest', function() {
      ...
      //var instane = new CompetitionLabsApplicationServices.CreateCompetitionRequest();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.CreateCompetitionRequest);
    });

    it('should have the property customFields (base name: "customFields")', function() {
      // uncomment below and update the code to test the property customFields
      //var instance = new CompetitionLabsApplicationServices.CreateCompetitionRequest();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateAchievementRequestAllOf();
  });
  ...
  describe('CreateAchievementRequestAllOf', function() {
    it('should create an instance of CreateAchievementRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateAchievementRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateAchievementRequestAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.CreateAchievementRequestAllOf();

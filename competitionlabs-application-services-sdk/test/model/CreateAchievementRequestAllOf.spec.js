...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.CreateAchievementRequestAllOf();
  });
  ...
  describe('CreateAchievementRequestAllOf', function() {
    it('should create an instance of CreateAchievementRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsApplicationServices.CreateAchievementRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.CreateAchievementRequestAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsApplicationServices.CreateAchievementRequestAllOf();

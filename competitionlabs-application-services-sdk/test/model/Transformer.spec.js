...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Transformer();
  });
  ...
  describe('Transformer', function() {
    it('should create an instance of Transformer', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Transformer();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Transformer);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.Transformer();

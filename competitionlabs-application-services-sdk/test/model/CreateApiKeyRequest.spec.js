...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateApiKeyRequest();
  });
  ...
  describe('CreateApiKeyRequest', function() {
    it('should create an instance of CreateApiKeyRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateApiKeyRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateApiKeyRequest);
    });

    it('should have the property customFields (base name: "customFields")', function() {
      // uncomment below and update the code to test the property customFields
      //var instance = new CompetitionLabsAdminServices.CreateApiKeyRequest();

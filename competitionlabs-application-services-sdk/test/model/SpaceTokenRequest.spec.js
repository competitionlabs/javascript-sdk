...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.SpaceTokenRequest();
  });
  ...
  describe('SpaceTokenRequest', function() {
    it('should create an instance of SpaceTokenRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.SpaceTokenRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.SpaceTokenRequest);
    });
    ...
    it('should have the property userToken (base name: "userToken")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.SpaceTokenRequest();

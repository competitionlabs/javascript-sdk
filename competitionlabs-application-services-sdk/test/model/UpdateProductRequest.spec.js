...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateProductRequest();
  });
  ...
  describe('UpdateProductRequest', function() {
    it('should create an instance of UpdateProductRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateProductRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateProductRequest);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.UpdateProductRequest();

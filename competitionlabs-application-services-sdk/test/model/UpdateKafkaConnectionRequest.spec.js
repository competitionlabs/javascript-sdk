...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateKafkaConnectionRequest();
  });
  ...
  describe('UpdateKafkaConnectionRequest', function() {
    it('should create an instance of UpdateKafkaConnectionRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateKafkaConnectionRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateKafkaConnectionRequest);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.UpdateKafkaConnectionRequest();

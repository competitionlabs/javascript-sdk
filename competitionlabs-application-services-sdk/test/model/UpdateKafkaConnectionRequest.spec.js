...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.UpdateKafkaConnectionRequest();
  });
  ...
  describe('UpdateKafkaConnectionRequest', function() {
    it('should create an instance of UpdateKafkaConnectionRequest', function() {
      ...
      //var instane = new CompetitionLabsApplicationServices.UpdateKafkaConnectionRequest();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.UpdateKafkaConnectionRequest);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsApplicationServices.UpdateKafkaConnectionRequest();

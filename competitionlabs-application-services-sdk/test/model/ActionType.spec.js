...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.ActionType();
  });
  ...
  describe('ActionType', function() {
    it('should create an instance of ActionType', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.ActionType();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.ActionType);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.ActionType();

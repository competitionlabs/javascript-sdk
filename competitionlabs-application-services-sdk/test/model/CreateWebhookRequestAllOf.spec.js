...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateWebhookRequestAllOf();
  });
  ...
  describe('CreateWebhookRequestAllOf', function() {
    it('should create an instance of CreateWebhookRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateWebhookRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateWebhookRequestAllOf);
    });
    ...
    it('should have the property postToUrl (base name: "postToUrl")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.CreateWebhookRequestAllOf();

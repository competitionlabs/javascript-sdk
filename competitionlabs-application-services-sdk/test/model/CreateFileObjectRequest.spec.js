...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateFileObjectRequest();
  });
  ...
  describe('CreateFileObjectRequest', function() {
    it('should create an instance of CreateFileObjectRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateFileObjectRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateFileObjectRequest);
    });

    it('should have the property customFields (base name: "customFields")', function() {
      // uncomment below and update the code to test the property customFields
      //var instance = new CompetitionLabsAdminServices.CreateFileObjectRequest();

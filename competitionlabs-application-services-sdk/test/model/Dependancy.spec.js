...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Dependancy();
  });
  ...
  describe('Dependancy', function() {
    it('should create an instance of Dependancy', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Dependancy();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Dependancy);
    });
    ...
    it('should have the property entityType (base name: "entityType")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.Dependancy();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UnitOfMeasure();
  });
  ...
  describe('UnitOfMeasure', function() {
    it('should create an instance of UnitOfMeasure', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UnitOfMeasure();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UnitOfMeasure);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.UnitOfMeasure();

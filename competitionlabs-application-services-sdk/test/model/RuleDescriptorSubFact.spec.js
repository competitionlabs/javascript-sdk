...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.RuleDescriptorSubFact();
  });
  ...
  describe('RuleDescriptorSubFact', function() {
    it('should create an instance of RuleDescriptorSubFact', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.RuleDescriptorSubFact();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.RuleDescriptorSubFact);
    });
    ...
    it('should have the property operators (base name: "operators")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.RuleDescriptorSubFact();

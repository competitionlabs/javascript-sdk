...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.AwardResponse();
  });
  ...
  describe('AwardResponse', function() {
    it('should create an instance of AwardResponse', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.AwardResponse();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.AwardResponse);
    });

    it('should have the property meta (base name: "meta")', function() {
      // uncomment below and update the code to test the property meta
      //var instance = new CompetitionLabsAdminServices.AwardResponse();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateUserRequest();
  });
  ...
  describe('UpdateUserRequest', function() {
    it('should create an instance of UpdateUserRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateUserRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateUserRequest);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.UpdateUserRequest();

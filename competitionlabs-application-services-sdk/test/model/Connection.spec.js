...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Connection();
  });
  ...
  describe('Connection', function() {
    it('should create an instance of Connection', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Connection();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Connection);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.Connection();

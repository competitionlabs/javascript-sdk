...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateMessageRequestAllOf();
  });
  ...
  describe('UpdateMessageRequestAllOf', function() {
    it('should create an instance of UpdateMessageRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateMessageRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateMessageRequestAllOf);
    });
    ...
    it('should have the property dependantOn (base name: "dependantOn")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.UpdateMessageRequestAllOf();

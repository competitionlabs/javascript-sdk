...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.UpdateMessageRequestAllOf();
  });
  ...
  describe('UpdateMessageRequestAllOf', function() {
    it('should create an instance of UpdateMessageRequestAllOf', function() {
      // uncomment below and update the code to test UpdateMessageRequestAllOf
      //var instane = new CompetitionLabsApplicationServices.UpdateMessageRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.UpdateMessageRequestAllOf);
    });
    ...
    it('should have the property memberGroup (base name: "memberGroup")', function() {
      ...
      //var instance = new CompetitionLabsApplicationServices.UpdateMessageRequestAllOf();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsJavascriptSdk.UpdateMessageRequestAllOf();
  });
  ...
  describe('UpdateMessageRequestAllOf', function() {
    it('should create an instance of UpdateMessageRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsJavascriptSdk.UpdateMessageRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsJavascriptSdk.UpdateMessageRequestAllOf);
    });

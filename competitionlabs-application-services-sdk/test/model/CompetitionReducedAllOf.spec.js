...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CompetitionReducedAllOf();
  });
  ...
  describe('CompetitionReducedAllOf', function() {
    it('should create an instance of CompetitionReducedAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CompetitionReducedAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CompetitionReducedAllOf);
    });
    ...
    it('should have the property competitionType (base name: "competitionType")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.CompetitionReducedAllOf();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateEntityRewardRequest();
  });
  ...
  describe('UpdateEntityRewardRequest', function() {
    it('should create an instance of UpdateEntityRewardRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateEntityRewardRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateEntityRewardRequest);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.UpdateEntityRewardRequest();

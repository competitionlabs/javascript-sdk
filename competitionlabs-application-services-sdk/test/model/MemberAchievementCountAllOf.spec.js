...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.MemberAchievementCountAllOf();
  });
  ...
  describe('MemberAchievementCountAllOf', function() {
    it('should create an instance of MemberAchievementCountAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.MemberAchievementCountAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.MemberAchievementCountAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.MemberAchievementCountAllOf();

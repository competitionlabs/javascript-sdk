...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.ModelDefault();
  });
  ...
  describe('ModelDefault', function() {
    it('should create an instance of ModelDefault', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.ModelDefault();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.ModelDefault);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.ModelDefault();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CountResponse();
  });
  ...
  describe('CountResponse', function() {
    it('should create an instance of CountResponse', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CountResponse();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CountResponse);
    });

    it('should have the property entityId (base name: "entityId")', function() {
      // uncomment below and update the code to test the property entityId
      //var instance = new CompetitionLabsAdminServices.CountResponse();

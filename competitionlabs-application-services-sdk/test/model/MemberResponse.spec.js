...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.MemberResponse();
  });
  ...
  describe('MemberResponse', function() {
    it('should create an instance of MemberResponse', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.MemberResponse();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.MemberResponse);
    });

    it('should have the property meta (base name: "meta")', function() {
      // uncomment below and update the code to test the property meta
      //var instance = new CompetitionLabsAdminServices.MemberResponse();

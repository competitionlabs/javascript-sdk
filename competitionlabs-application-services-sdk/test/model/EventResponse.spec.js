...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.EventResponse();
  });
  ...
  describe('EventResponse', function() {
    it('should create an instance of EventResponse', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.EventResponse();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.EventResponse);
    });

    it('should have the property meta (base name: "meta")', function() {
      // uncomment below and update the code to test the property meta
      //var instance = new CompetitionLabsAdminServices.EventResponse();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Location();
  });
  ...
  describe('Location', function() {
    it('should create an instance of Location', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Location();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Location);
    });

    it('should have the property lat (base name: "lat")', function() {
      // uncomment below and update the code to test the property lat
      //var instance = new CompetitionLabsAdminServices.Location();

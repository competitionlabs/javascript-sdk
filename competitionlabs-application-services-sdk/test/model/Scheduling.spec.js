...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Scheduling();
  });
  ...
  describe('Scheduling', function() {
    it('should create an instance of Scheduling', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Scheduling();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Scheduling);
    });
    ...
    it('should have the property scheduleType (base name: "scheduleType")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.Scheduling();

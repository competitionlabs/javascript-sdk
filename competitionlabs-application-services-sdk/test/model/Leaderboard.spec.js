...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Leaderboard();
  });
  ...
  describe('Leaderboard', function() {
    it('should create an instance of Leaderboard', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Leaderboard();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Leaderboard);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.Leaderboard();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.MetaExtended();
  });
  ...
  describe('MetaExtended', function() {
    it('should create an instance of MetaExtended', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.MetaExtended();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.MetaExtended);
    });
    ...
    it('should have the property objectType (base name: "objectType")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.MetaExtended();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.User();
  });
  ...
  describe('User', function() {
    it('should create an instance of User', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.User();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.User);
    });

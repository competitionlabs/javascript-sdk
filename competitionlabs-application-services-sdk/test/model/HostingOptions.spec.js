...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.HostingOptions();
  });
  ...
  describe('HostingOptions', function() {
    it('should create an instance of HostingOptions', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.HostingOptions();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.HostingOptions);
    });
    ...
    it('should have the property indexFileName (base name: "indexFileName")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.HostingOptions();

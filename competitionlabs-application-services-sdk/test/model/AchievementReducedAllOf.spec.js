...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.AchievementReducedAllOf();
  });
  ...
  describe('AchievementReducedAllOf', function() {
    it('should create an instance of AchievementReducedAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.AchievementReducedAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.AchievementReducedAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.AchievementReducedAllOf();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateMemberRequestAllOf();
  });
  ...
  describe('UpdateMemberRequestAllOf', function() {
    it('should create an instance of UpdateMemberRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateMemberRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateMemberRequestAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.UpdateMemberRequestAllOf();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateKafkaConnectionRequest();
  });
  ...
  describe('CreateKafkaConnectionRequest', function() {
    it('should create an instance of CreateKafkaConnectionRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateKafkaConnectionRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateKafkaConnectionRequest);
    });
    ...
    it('should have the property objectType (base name: "objectType")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.CreateKafkaConnectionRequest();

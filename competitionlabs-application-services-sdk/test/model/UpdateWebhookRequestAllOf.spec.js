...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsJavascriptSdk.UpdateWebhookRequestAllOf();
  });
  ...
  describe('UpdateWebhookRequestAllOf', function() {
    it('should create an instance of UpdateWebhookRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsJavascriptSdk.UpdateWebhookRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsJavascriptSdk.UpdateWebhookRequestAllOf);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.ProductReduced();
  });
  ...
  describe('ProductReduced', function() {
    it('should create an instance of ProductReduced', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.ProductReduced();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.ProductReduced);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.ProductReduced();

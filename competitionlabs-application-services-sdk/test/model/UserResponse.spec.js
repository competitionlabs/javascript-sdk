...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UserResponse();
  });
  ...
  describe('UserResponse', function() {
    it('should create an instance of UserResponse', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UserResponse();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UserResponse);
    });

    it('should have the property meta (base name: "meta")', function() {
      // uncomment below and update the code to test the property meta
      //var instance = new CompetitionLabsAdminServices.UserResponse();

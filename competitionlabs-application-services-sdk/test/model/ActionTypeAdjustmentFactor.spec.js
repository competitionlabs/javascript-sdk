...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.ActionTypeAdjustmentFactor();
  });
  ...
  describe('ActionTypeAdjustmentFactor', function() {
    it('should create an instance of ActionTypeAdjustmentFactor', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.ActionTypeAdjustmentFactor();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.ActionTypeAdjustmentFactor);
    });
    ...
    it('should have the property adjustmentFactor (base name: "adjustmentFactor")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.ActionTypeAdjustmentFactor();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.QueryRequest();
  });
  ...
  describe('QueryRequest', function() {
    it('should create an instance of QueryRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.QueryRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.QueryRequest);
    });

    it('should have the property must (base name: "must")', function() {
      // uncomment below and update the code to test the property must
      //var instance = new CompetitionLabsAdminServices.QueryRequest();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Language();
  });
  ...
  describe('Language', function() {
    it('should create an instance of Language', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Language();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Language);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.Language();

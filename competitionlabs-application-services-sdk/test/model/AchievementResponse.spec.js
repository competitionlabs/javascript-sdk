...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.AchievementResponse();
  });
  ...
  describe('AchievementResponse', function() {
    it('should create an instance of AchievementResponse', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.AchievementResponse();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.AchievementResponse);
    });

    it('should have the property meta (base name: "meta")', function() {
      // uncomment below and update the code to test the property meta
      //var instance = new CompetitionLabsAdminServices.AchievementResponse();

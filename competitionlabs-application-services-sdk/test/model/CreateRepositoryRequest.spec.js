...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateRepositoryRequest();
  });
  ...
  describe('CreateRepositoryRequest', function() {
    it('should create an instance of CreateRepositoryRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateRepositoryRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateRepositoryRequest);
    });

    it('should have the property customFields (base name: "customFields")', function() {
      // uncomment below and update the code to test the property customFields
      //var instance = new CompetitionLabsAdminServices.CreateRepositoryRequest();

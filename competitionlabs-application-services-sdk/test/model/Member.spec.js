...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Member();
  });
  ...
  describe('Member', function() {
    it('should create an instance of Member', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Member();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Member);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.Member();

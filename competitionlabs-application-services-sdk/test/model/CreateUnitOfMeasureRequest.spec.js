...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateUnitOfMeasureRequest();
  });
  ...
  describe('CreateUnitOfMeasureRequest', function() {
    it('should create an instance of CreateUnitOfMeasureRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateUnitOfMeasureRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateUnitOfMeasureRequest);
    });

    it('should have the property customFields (base name: "customFields")', function() {
      // uncomment below and update the code to test the property customFields
      //var instance = new CompetitionLabsAdminServices.CreateUnitOfMeasureRequest();

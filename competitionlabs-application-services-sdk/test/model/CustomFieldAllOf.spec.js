...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CustomFieldAllOf();
  });
  ...
  describe('CustomFieldAllOf', function() {
    it('should create an instance of CustomFieldAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CustomFieldAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CustomFieldAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.CustomFieldAllOf();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.RangeQuery();
  });
  ...
  describe('RangeQuery', function() {
    it('should create an instance of RangeQuery', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.RangeQuery();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.RangeQuery);
    });
    ...
    it('should have the property queryField (base name: "queryField")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.RangeQuery();

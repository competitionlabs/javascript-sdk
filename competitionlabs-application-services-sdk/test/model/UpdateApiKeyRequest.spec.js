...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateApiKeyRequest();
  });
  ...
  describe('UpdateApiKeyRequest', function() {
    it('should create an instance of UpdateApiKeyRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateApiKeyRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateApiKeyRequest);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.UpdateApiKeyRequest();

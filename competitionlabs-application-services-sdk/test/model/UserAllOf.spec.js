...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UserAllOf();
  });
  ...
  describe('UserAllOf', function() {
    it('should create an instance of UserAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UserAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UserAllOf);
    });

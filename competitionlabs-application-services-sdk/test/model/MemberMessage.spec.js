...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.MemberMessage();
  });
  ...
  describe('MemberMessage', function() {
    it('should create an instance of MemberMessage', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.MemberMessage();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.MemberMessage);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.MemberMessage();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Contact();
  });
  ...
  describe('Contact', function() {
    it('should create an instance of Contact', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Contact();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Contact);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.Contact();

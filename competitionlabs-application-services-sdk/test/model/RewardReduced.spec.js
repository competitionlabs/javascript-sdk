...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.RewardReduced();
  });
  ...
  describe('RewardReduced', function() {
    it('should create an instance of RewardReduced', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.RewardReduced();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.RewardReduced);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.RewardReduced();

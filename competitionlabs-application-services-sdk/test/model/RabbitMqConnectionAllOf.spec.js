...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.RabbitMqConnectionAllOf();
  });
  ...
  describe('RabbitMqConnectionAllOf', function() {
    it('should create an instance of RabbitMqConnectionAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.RabbitMqConnectionAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.RabbitMqConnectionAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.RabbitMqConnectionAllOf();

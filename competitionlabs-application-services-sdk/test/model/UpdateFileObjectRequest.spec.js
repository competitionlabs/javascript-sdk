...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateFileObjectRequest();
  });
  ...
  describe('UpdateFileObjectRequest', function() {
    it('should create an instance of UpdateFileObjectRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateFileObjectRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateFileObjectRequest);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.UpdateFileObjectRequest();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsJavascriptSdk.UpdateFileObjectRequest();
  });
  ...
  describe('UpdateFileObjectRequest', function() {
    it('should create an instance of UpdateFileObjectRequest', function() {
      ...
      //var instane = new @CompetitionlabsJavascriptSdk.UpdateFileObjectRequest();
      //expect(instance).to.be.a(@CompetitionlabsJavascriptSdk.UpdateFileObjectRequest);
    });

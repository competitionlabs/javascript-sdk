...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Tags();
  });
  ...
  describe('Tags', function() {
    it('should create an instance of Tags', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Tags();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Tags);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.Tags();

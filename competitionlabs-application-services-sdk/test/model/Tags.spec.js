...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.Tags();
  });
  ...
  describe('Tags', function() {
    it('should create an instance of Tags', function() {
      ...
      //var instane = new CompetitionLabsApplicationServices.Tags();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.Tags);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsApplicationServices.Tags();

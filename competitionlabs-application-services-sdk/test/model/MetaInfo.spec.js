...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.MetaInfo();
  });
  ...
  describe('MetaInfo', function() {
    it('should create an instance of MetaInfo', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.MetaInfo();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.MetaInfo);
    });
    ...
    it('should have the property objectType (base name: "objectType")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.MetaInfo();

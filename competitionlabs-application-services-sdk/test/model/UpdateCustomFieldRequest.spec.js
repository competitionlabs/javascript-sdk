...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateCustomFieldRequest();
  });
  ...
  describe('UpdateCustomFieldRequest', function() {
    it('should create an instance of UpdateCustomFieldRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateCustomFieldRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateCustomFieldRequest);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.UpdateCustomFieldRequest();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.Message();
  });
  ...
  describe('Message', function() {
    it('should create an instance of Message', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.Message();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.Message);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CompetitionLabsAdminServices.Message();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.TestMessageRequest();
  });
  ...
  describe('TestMessageRequest', function() {
    it('should create an instance of TestMessageRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.TestMessageRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.TestMessageRequest);
    });
    ...
    it('should have the property members (base name: "members")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.TestMessageRequest();

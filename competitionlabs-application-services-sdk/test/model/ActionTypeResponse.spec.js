...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.ActionTypeResponse();
  });
  ...
  describe('ActionTypeResponse', function() {
    it('should create an instance of ActionTypeResponse', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.ActionTypeResponse();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.ActionTypeResponse);
    });

    it('should have the property meta (base name: "meta")', function() {
      // uncomment below and update the code to test the property meta
      //var instance = new CompetitionLabsAdminServices.ActionTypeResponse();

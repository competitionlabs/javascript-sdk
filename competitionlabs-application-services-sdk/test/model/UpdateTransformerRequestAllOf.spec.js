...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.UpdateTransformerRequestAllOf();
  });
  ...
  describe('UpdateTransformerRequestAllOf', function() {
    it('should create an instance of UpdateTransformerRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.UpdateTransformerRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.UpdateTransformerRequestAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.UpdateTransformerRequestAllOf();

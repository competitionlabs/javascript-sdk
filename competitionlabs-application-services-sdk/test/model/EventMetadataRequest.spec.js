...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsApplicationServicesSdk.EventMetadataRequest();
  });
  ...
  describe('EventMetadataRequest', function() {
    it('should create an instance of EventMetadataRequest', function() {
      ...
      //var instane = new @CompetitionlabsApplicationServicesSdk.EventMetadataRequest();
      //expect(instance).to.be.a(@CompetitionlabsApplicationServicesSdk.EventMetadataRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.CreateKafkaConnectionRequestAllOf();
  });
  ...
  describe('CreateKafkaConnectionRequestAllOf', function() {
    it('should create an instance of CreateKafkaConnectionRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.CreateKafkaConnectionRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.CreateKafkaConnectionRequestAllOf);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new CompetitionLabsAdminServices.CreateKafkaConnectionRequestAllOf();

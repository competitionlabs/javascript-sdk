...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.MessageResponse();
  });
  ...
  describe('MessageResponse', function() {
    it('should create an instance of MessageResponse', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.MessageResponse();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.MessageResponse);
    });

    it('should have the property meta (base name: "meta")', function() {
      // uncomment below and update the code to test the property meta
      //var instance = new CompetitionLabsAdminServices.MessageResponse();

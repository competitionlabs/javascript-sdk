...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.MaxMin();
  });
  ...
  describe('MaxMin', function() {
    it('should create an instance of MaxMin', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.MaxMin();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.MaxMin);
    });
    ...
    it('should have the property maximum (base name: "maximum")', function() {
      ...
      //var instance = new CompetitionLabsAdminServices.MaxMin();

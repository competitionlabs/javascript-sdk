...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsAdminServices.ChangePasswordRequest();
  });
  ...
  describe('ChangePasswordRequest', function() {
    it('should create an instance of ChangePasswordRequest', function() {
      ...
      //var instane = new CompetitionLabsAdminServices.ChangePasswordRequest();
      //expect(instance).to.be.a(CompetitionLabsAdminServices.ChangePasswordRequest);
    });

    it('should have the property email (base name: "email")', function() {
      // uncomment below and update the code to test the property email
      //var instance = new CompetitionLabsAdminServices.ChangePasswordRequest();

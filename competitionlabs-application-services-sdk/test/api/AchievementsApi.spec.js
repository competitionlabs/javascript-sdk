...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.AchievementsApi();
  });
  ...
  describe('AchievementsApi', function() {
    ...
    describe('getAchievementIconList', function() {
      it('should call getAchievementIconList successfully', function(done) {
        //uncomment below and update the code to test getAchievementIconList
        //instance.getAchievementIconList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('uploadAchievementsIcon', function() {
      it('should call uploadAchievementsIcon successfully', function(done) {
        //uncomment below and update the code to test uploadAchievementsIcon
        //instance.uploadAchievementsIcon(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();

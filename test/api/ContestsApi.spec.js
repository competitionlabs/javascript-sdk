...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.ContestsApi();
  });
  ...
  describe('ContestsApi', function() {
    ...
    describe('deleteContestsByQuery', function() {
      it('should call deleteContestsByQuery successfully', function(done) {
        //uncomment below and update the code to test deleteContestsByQuery
        //instance.deleteContestsByQuery(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();

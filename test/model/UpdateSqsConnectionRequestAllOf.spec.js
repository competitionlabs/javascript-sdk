...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CompetitionLabsApplicationServices.UpdateSqsConnectionRequestAllOf();
  });
  ...
  describe('UpdateSqsConnectionRequestAllOf', function() {
    it('should create an instance of UpdateSqsConnectionRequestAllOf', function() {
      ...
      //var instane = new CompetitionLabsApplicationServices.UpdateSqsConnectionRequestAllOf();
      //expect(instance).to.be.a(CompetitionLabsApplicationServices.UpdateSqsConnectionRequestAllOf);
    });

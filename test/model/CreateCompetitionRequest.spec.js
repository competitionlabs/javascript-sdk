...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsJavascriptSdk.CreateCompetitionRequest();
  });
  ...
  describe('CreateCompetitionRequest', function() {
    it('should create an instance of CreateCompetitionRequest', function() {
      ...
      //var instane = new @CompetitionlabsJavascriptSdk.CreateCompetitionRequest();
      //expect(instance).to.be.a(@CompetitionlabsJavascriptSdk.CreateCompetitionRequest);
    });

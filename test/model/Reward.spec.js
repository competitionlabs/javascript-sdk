...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsJavascriptSdk.Reward();
  });
  ...
  describe('Reward', function() {
    it('should create an instance of Reward', function() {
      ...
      //var instane = new @CompetitionlabsJavascriptSdk.Reward();
      //expect(instance).to.be.a(@CompetitionlabsJavascriptSdk.Reward);
    });

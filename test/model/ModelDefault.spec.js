...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsJavascriptSdk.ModelDefault();
  });
  ...
  describe('ModelDefault', function() {
    it('should create an instance of ModelDefault', function() {
      ...
      //var instane = new @CompetitionlabsJavascriptSdk.ModelDefault();
      //expect(instance).to.be.a(@CompetitionlabsJavascriptSdk.ModelDefault);
    });

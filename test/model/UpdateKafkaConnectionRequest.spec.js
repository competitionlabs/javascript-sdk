...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsJavascriptSdk.UpdateKafkaConnectionRequest();
  });
  ...
  describe('UpdateKafkaConnectionRequest', function() {
    it('should create an instance of UpdateKafkaConnectionRequest', function() {
      ...
      //var instane = new @CompetitionlabsJavascriptSdk.UpdateKafkaConnectionRequest();
      //expect(instance).to.be.a(@CompetitionlabsJavascriptSdk.UpdateKafkaConnectionRequest);
    });

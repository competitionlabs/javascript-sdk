...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsJavascriptSdk.EventAllOf();
  });
  ...
  describe('EventAllOf', function() {
    it('should create an instance of EventAllOf', function() {
      ...
      //var instane = new @CompetitionlabsJavascriptSdk.EventAllOf();
      //expect(instance).to.be.a(@CompetitionlabsJavascriptSdk.EventAllOf);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsJavascriptSdk.FileObject();
  });
  ...
  describe('FileObject', function() {
    it('should create an instance of FileObject', function() {
      ...
      //var instane = new @CompetitionlabsJavascriptSdk.FileObject();
      //expect(instance).to.be.a(@CompetitionlabsJavascriptSdk.FileObject);
    });

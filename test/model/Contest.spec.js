...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsJavascriptSdk.Contest();
  });
  ...
  describe('Contest', function() {
    it('should create an instance of Contest', function() {
      ...
      //var instane = new @CompetitionlabsJavascriptSdk.Contest();
      //expect(instance).to.be.a(@CompetitionlabsJavascriptSdk.Contest);
    });

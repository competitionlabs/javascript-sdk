# @CompetitionlabsInsightsServicesSdk.SpacesApi
...
let apiInstance = new @CompetitionlabsInsightsServicesSdk.SpacesApi();
let body = new @CompetitionlabsInsightsServicesSdk.CreateSpaceRequest(); // CreateSpaceRequest | Create a Space for the user in the CompetitionLabs
let opts = {

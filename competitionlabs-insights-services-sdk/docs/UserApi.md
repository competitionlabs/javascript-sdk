# @CompetitionlabsInsightsServicesSdk.UserApi
...
let apiInstance = new @CompetitionlabsInsightsServicesSdk.UserApi();
let body = new @CompetitionlabsInsightsServicesSdk.ChangePasswordRequest(); // ChangePasswordRequest | Change the users password
...
let apiInstance = new @CompetitionlabsInsightsServicesSdk.UserApi();
let body = new @CompetitionlabsInsightsServicesSdk.CreateMessageRequest(); // CreateMessageRequest | Mark User messages as read
let opts = {
  'X_API_KEY': "X_API_KEY_example" // String | The admin API Key generated from CompetitionLabs back office
};

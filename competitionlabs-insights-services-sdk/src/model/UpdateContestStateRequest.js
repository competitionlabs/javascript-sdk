...
class UpdateContestStateRequest {
     ...
     * @param contestId {String} A unique identifier of a Contest
     * @param status {module:model/ContestStateOperations} 
     */
    constructor(contestId, status) { 
        
        UpdateContestStateRequest.initialize(this, contestId, status);
    }

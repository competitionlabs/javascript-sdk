...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Connection();
  });
  ...
  describe('Connection', function() {
    it('should create an instance of Connection', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Connection();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Connection);
    });

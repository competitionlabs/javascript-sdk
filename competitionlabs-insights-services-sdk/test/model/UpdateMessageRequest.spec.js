...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateMessageRequest();
  });
  ...
  describe('UpdateMessageRequest', function() {
    it('should create an instance of UpdateMessageRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateMessageRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateMessageRequest);
    });

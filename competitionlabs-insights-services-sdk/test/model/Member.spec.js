...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Member();
  });
  ...
  describe('Member', function() {
    it('should create an instance of Member', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Member();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Member);
    });

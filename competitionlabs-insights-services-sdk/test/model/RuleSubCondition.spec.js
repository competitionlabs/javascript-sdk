...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.RuleSubCondition();
  });
  ...
  describe('RuleSubCondition', function() {
    it('should create an instance of RuleSubCondition', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.RuleSubCondition();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.RuleSubCondition);
    });

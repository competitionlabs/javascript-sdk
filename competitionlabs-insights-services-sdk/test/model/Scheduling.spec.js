...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Scheduling();
  });
  ...
  describe('Scheduling', function() {
    it('should create an instance of Scheduling', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Scheduling();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Scheduling);
    });

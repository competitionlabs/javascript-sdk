...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.TranslatedField();
  });
  ...
  describe('TranslatedField', function() {
    it('should create an instance of TranslatedField', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.TranslatedField();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.TranslatedField);
    });

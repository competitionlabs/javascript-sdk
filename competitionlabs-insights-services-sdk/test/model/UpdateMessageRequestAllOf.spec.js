...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateMessageRequestAllOf();
  });
  ...
  describe('UpdateMessageRequestAllOf', function() {
    it('should create an instance of UpdateMessageRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateMessageRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateMessageRequestAllOf);
    });

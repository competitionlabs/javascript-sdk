...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.RewardReduced();
  });
  ...
  describe('RewardReduced', function() {
    it('should create an instance of RewardReduced', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.RewardReduced();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.RewardReduced);
    });

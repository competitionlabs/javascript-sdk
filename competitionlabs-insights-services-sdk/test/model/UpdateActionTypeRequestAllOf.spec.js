...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateActionTypeRequestAllOf();
  });
  ...
  describe('UpdateActionTypeRequestAllOf', function() {
    it('should create an instance of UpdateActionTypeRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateActionTypeRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateActionTypeRequestAllOf);
    });

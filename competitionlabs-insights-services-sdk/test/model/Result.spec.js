...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Result();
  });
  ...
  describe('Result', function() {
    it('should create an instance of Result', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Result();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Result);
    });

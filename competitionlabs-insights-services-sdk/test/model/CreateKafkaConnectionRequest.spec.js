...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateKafkaConnectionRequest();
  });
  ...
  describe('CreateKafkaConnectionRequest', function() {
    it('should create an instance of CreateKafkaConnectionRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateKafkaConnectionRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateKafkaConnectionRequest);
    });

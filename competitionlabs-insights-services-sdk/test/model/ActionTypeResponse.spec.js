...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.ActionTypeResponse();
  });
  ...
  describe('ActionTypeResponse', function() {
    it('should create an instance of ActionTypeResponse', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.ActionTypeResponse();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.ActionTypeResponse);
    });

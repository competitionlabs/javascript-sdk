...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateWebhookRequestAllOf();
  });
  ...
  describe('UpdateWebhookRequestAllOf', function() {
    it('should create an instance of UpdateWebhookRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateWebhookRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateWebhookRequestAllOf);
    });

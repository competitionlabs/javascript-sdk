...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateAchievementRequest();
  });
  ...
  describe('UpdateAchievementRequest', function() {
    it('should create an instance of UpdateAchievementRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateAchievementRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateAchievementRequest);
    });

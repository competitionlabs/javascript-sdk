...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Location();
  });
  ...
  describe('Location', function() {
    it('should create an instance of Location', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Location();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Location);
    });

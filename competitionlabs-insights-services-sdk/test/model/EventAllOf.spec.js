...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.EventAllOf();
  });
  ...
  describe('EventAllOf', function() {
    it('should create an instance of EventAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.EventAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.EventAllOf);
    });

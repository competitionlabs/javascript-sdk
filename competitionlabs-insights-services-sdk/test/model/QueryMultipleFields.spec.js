...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.QueryMultipleFields();
  });
  ...
  describe('QueryMultipleFields', function() {
    it('should create an instance of QueryMultipleFields', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.QueryMultipleFields();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.QueryMultipleFields);
    });

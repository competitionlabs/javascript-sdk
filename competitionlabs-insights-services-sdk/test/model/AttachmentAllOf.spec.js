...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.AttachmentAllOf();
  });
  ...
  describe('AttachmentAllOf', function() {
    it('should create an instance of AttachmentAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.AttachmentAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.AttachmentAllOf);
    });

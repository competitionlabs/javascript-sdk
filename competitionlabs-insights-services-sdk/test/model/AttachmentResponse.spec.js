...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.AttachmentResponse();
  });
  ...
  describe('AttachmentResponse', function() {
    it('should create an instance of AttachmentResponse', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.AttachmentResponse();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.AttachmentResponse);
    });

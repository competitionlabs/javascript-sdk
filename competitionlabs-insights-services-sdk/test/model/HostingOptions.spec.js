...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.HostingOptions();
  });
  ...
  describe('HostingOptions', function() {
    it('should create an instance of HostingOptions', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.HostingOptions();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.HostingOptions);
    });

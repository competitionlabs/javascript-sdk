...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.ActionTypeAllOf();
  });
  ...
  describe('ActionTypeAllOf', function() {
    it('should create an instance of ActionTypeAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.ActionTypeAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.ActionTypeAllOf);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateSqsConnectionRequest();
  });
  ...
  describe('CreateSqsConnectionRequest', function() {
    it('should create an instance of CreateSqsConnectionRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateSqsConnectionRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateSqsConnectionRequest);
    });

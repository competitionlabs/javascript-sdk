...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.SpaceTokenRequest();
  });
  ...
  describe('SpaceTokenRequest', function() {
    it('should create an instance of SpaceTokenRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.SpaceTokenRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.SpaceTokenRequest);
    });

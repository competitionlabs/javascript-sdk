...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.ApiResponse();
  });
  ...
  describe('ApiResponse', function() {
    it('should create an instance of ApiResponse', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.ApiResponse();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.ApiResponse);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CustomField();
  });
  ...
  describe('CustomField', function() {
    it('should create an instance of CustomField', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CustomField();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CustomField);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.RuleSet();
  });
  ...
  describe('RuleSet', function() {
    it('should create an instance of RuleSet', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.RuleSet();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.RuleSet);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.ComplexFilter();
  });
  ...
  describe('ComplexFilter', function() {
    it('should create an instance of ComplexFilter', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.ComplexFilter();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.ComplexFilter);
    });

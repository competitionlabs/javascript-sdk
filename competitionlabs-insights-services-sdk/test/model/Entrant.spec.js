...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Entrant();
  });
  ...
  describe('Entrant', function() {
    it('should create an instance of Entrant', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Entrant();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Entrant);
    });

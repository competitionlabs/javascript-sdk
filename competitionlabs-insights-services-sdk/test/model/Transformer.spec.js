...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Transformer();
  });
  ...
  describe('Transformer', function() {
    it('should create an instance of Transformer', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Transformer();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Transformer);
    });

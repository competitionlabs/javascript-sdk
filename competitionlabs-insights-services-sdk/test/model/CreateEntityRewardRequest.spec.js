...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateEntityRewardRequest();
  });
  ...
  describe('CreateEntityRewardRequest', function() {
    it('should create an instance of CreateEntityRewardRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateEntityRewardRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateEntityRewardRequest);
    });

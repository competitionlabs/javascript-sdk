...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateSpaceRequest();
  });
  ...
  describe('CreateSpaceRequest', function() {
    it('should create an instance of CreateSpaceRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateSpaceRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateSpaceRequest);
    });

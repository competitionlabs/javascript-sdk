...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UserAllOf();
  });
  ...
  describe('UserAllOf', function() {
    it('should create an instance of UserAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UserAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UserAllOf);
    });

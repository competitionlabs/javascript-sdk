...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.ContestReducedResponse();
  });
  ...
  describe('ContestReducedResponse', function() {
    it('should create an instance of ContestReducedResponse', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.ContestReducedResponse();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.ContestReducedResponse);
    });

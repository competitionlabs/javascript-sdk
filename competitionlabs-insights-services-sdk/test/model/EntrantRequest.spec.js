...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.EntrantRequest();
  });
  ...
  describe('EntrantRequest', function() {
    it('should create an instance of EntrantRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.EntrantRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.EntrantRequest);
    });

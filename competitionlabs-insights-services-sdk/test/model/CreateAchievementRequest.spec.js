...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateAchievementRequest();
  });
  ...
  describe('CreateAchievementRequest', function() {
    it('should create an instance of CreateAchievementRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateAchievementRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateAchievementRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.MessageResponse();
  });
  ...
  describe('MessageResponse', function() {
    it('should create an instance of MessageResponse', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.MessageResponse();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.MessageResponse);
    });

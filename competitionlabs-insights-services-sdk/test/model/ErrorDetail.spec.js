...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.ErrorDetail();
  });
  ...
  describe('ErrorDetail', function() {
    it('should create an instance of ErrorDetail', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.ErrorDetail();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.ErrorDetail);
    });

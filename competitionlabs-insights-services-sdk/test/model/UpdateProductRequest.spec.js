...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateProductRequest();
  });
  ...
  describe('UpdateProductRequest', function() {
    it('should create an instance of UpdateProductRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateProductRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateProductRequest);
    });

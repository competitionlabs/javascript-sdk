...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.AwardAllOf();
  });
  ...
  describe('AwardAllOf', function() {
    it('should create an instance of AwardAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.AwardAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.AwardAllOf);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.MetaExtended();
  });
  ...
  describe('MetaExtended', function() {
    it('should create an instance of MetaExtended', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.MetaExtended();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.MetaExtended);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.RewardType();
  });
  ...
  describe('RewardType', function() {
    it('should create an instance of RewardType', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.RewardType();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.RewardType);
    });

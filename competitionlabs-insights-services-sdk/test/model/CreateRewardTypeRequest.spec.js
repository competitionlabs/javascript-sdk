...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateRewardTypeRequest();
  });
  ...
  describe('CreateRewardTypeRequest', function() {
    it('should create an instance of CreateRewardTypeRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateRewardTypeRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateRewardTypeRequest);
    });

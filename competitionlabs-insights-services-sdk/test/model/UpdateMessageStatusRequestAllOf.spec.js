...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateMessageStatusRequestAllOf();
  });
  ...
  describe('UpdateMessageStatusRequestAllOf', function() {
    it('should create an instance of UpdateMessageStatusRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateMessageStatusRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateMessageStatusRequestAllOf);
    });

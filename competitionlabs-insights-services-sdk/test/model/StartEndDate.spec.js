...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.StartEndDate();
  });
  ...
  describe('StartEndDate', function() {
    it('should create an instance of StartEndDate', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.StartEndDate();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.StartEndDate);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateCollaboratorRequest();
  });
  ...
  describe('CreateCollaboratorRequest', function() {
    it('should create an instance of CreateCollaboratorRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateCollaboratorRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateCollaboratorRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateFileObjectRequest();
  });
  ...
  describe('CreateFileObjectRequest', function() {
    it('should create an instance of CreateFileObjectRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateFileObjectRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateFileObjectRequest);
    });

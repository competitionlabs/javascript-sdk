...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateUnitOfMeasureRequest();
  });
  ...
  describe('UpdateUnitOfMeasureRequest', function() {
    it('should create an instance of UpdateUnitOfMeasureRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateUnitOfMeasureRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateUnitOfMeasureRequest);
    });

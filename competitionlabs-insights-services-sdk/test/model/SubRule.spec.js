...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.SubRule();
  });
  ...
  describe('SubRule', function() {
    it('should create an instance of SubRule', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.SubRule();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.SubRule);
    });

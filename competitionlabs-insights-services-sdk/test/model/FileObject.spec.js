...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.FileObject();
  });
  ...
  describe('FileObject', function() {
    it('should create an instance of FileObject', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.FileObject();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.FileObject);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.KafkaConnectionAllOf();
  });
  ...
  describe('KafkaConnectionAllOf', function() {
    it('should create an instance of KafkaConnectionAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.KafkaConnectionAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.KafkaConnectionAllOf);
    });

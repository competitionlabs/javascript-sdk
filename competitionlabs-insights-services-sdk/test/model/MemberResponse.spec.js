...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.MemberResponse();
  });
  ...
  describe('MemberResponse', function() {
    it('should create an instance of MemberResponse', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.MemberResponse();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.MemberResponse);
    });

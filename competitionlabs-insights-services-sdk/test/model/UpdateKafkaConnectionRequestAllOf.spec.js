...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateKafkaConnectionRequestAllOf();
  });
  ...
  describe('UpdateKafkaConnectionRequestAllOf', function() {
    it('should create an instance of UpdateKafkaConnectionRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateKafkaConnectionRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateKafkaConnectionRequestAllOf);
    });

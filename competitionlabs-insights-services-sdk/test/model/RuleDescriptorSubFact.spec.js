...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.RuleDescriptorSubFact();
  });
  ...
  describe('RuleDescriptorSubFact', function() {
    it('should create an instance of RuleDescriptorSubFact', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.RuleDescriptorSubFact();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.RuleDescriptorSubFact);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.EventResponse();
  });
  ...
  describe('EventResponse', function() {
    it('should create an instance of EventResponse', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.EventResponse();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.EventResponse);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateRewardRequest();
  });
  ...
  describe('UpdateRewardRequest', function() {
    it('should create an instance of UpdateRewardRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateRewardRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateRewardRequest);
    });

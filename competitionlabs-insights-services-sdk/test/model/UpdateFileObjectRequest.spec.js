...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateFileObjectRequest();
  });
  ...
  describe('UpdateFileObjectRequest', function() {
    it('should create an instance of UpdateFileObjectRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateFileObjectRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateFileObjectRequest);
    });

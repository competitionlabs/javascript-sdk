...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateTransformerRequestAllOf();
  });
  ...
  describe('UpdateTransformerRequestAllOf', function() {
    it('should create an instance of UpdateTransformerRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateTransformerRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateTransformerRequestAllOf);
    });

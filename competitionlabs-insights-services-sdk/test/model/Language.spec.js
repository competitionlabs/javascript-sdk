...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Language();
  });
  ...
  describe('Language', function() {
    it('should create an instance of Language', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Language();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Language);
    });

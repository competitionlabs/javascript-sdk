...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UserResponse();
  });
  ...
  describe('UserResponse', function() {
    it('should create an instance of UserResponse', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UserResponse();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UserResponse);
    });

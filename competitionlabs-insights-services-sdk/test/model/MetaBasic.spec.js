...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.MetaBasic();
  });
  ...
  describe('MetaBasic', function() {
    it('should create an instance of MetaBasic', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.MetaBasic();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.MetaBasic);
    });

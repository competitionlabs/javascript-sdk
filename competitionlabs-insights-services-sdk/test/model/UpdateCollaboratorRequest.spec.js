...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateCollaboratorRequest();
  });
  ...
  describe('UpdateCollaboratorRequest', function() {
    it('should create an instance of UpdateCollaboratorRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateCollaboratorRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateCollaboratorRequest);
    });

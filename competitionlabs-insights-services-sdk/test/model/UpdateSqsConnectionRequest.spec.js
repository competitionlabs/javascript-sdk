...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateSqsConnectionRequest();
  });
  ...
  describe('UpdateSqsConnectionRequest', function() {
    it('should create an instance of UpdateSqsConnectionRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateSqsConnectionRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateSqsConnectionRequest);
    });

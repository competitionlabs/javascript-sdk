...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateRewardTypeRequest();
  });
  ...
  describe('UpdateRewardTypeRequest', function() {
    it('should create an instance of UpdateRewardTypeRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateRewardTypeRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateRewardTypeRequest);
    });

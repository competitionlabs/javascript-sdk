...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateUnitOfMeasureRequest();
  });
  ...
  describe('CreateUnitOfMeasureRequest', function() {
    it('should create an instance of CreateUnitOfMeasureRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateUnitOfMeasureRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateUnitOfMeasureRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateMemberRequestAllOf();
  });
  ...
  describe('UpdateMemberRequestAllOf', function() {
    it('should create an instance of UpdateMemberRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateMemberRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateMemberRequestAllOf);
    });

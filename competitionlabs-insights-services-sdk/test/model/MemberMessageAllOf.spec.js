...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.MemberMessageAllOf();
  });
  ...
  describe('MemberMessageAllOf', function() {
    it('should create an instance of MemberMessageAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.MemberMessageAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.MemberMessageAllOf);
    });

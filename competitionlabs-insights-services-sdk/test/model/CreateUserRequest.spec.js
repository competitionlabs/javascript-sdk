...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateUserRequest();
  });
  ...
  describe('CreateUserRequest', function() {
    it('should create an instance of CreateUserRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateUserRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateUserRequest);
    });

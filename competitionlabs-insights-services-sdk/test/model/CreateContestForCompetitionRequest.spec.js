...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateContestForCompetitionRequest();
  });
  ...
  describe('CreateContestForCompetitionRequest', function() {
    it('should create an instance of CreateContestForCompetitionRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateContestForCompetitionRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateContestForCompetitionRequest);
    });

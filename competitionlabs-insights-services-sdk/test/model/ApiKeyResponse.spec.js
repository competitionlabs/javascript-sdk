...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.ApiKeyResponse();
  });
  ...
  describe('ApiKeyResponse', function() {
    it('should create an instance of ApiKeyResponse', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.ApiKeyResponse();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.ApiKeyResponse);
    });

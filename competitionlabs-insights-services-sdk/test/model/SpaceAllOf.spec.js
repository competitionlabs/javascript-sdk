...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.SpaceAllOf();
  });
  ...
  describe('SpaceAllOf', function() {
    it('should create an instance of SpaceAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.SpaceAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.SpaceAllOf);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.WebhookResponse();
  });
  ...
  describe('WebhookResponse', function() {
    it('should create an instance of WebhookResponse', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.WebhookResponse();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.WebhookResponse);
    });

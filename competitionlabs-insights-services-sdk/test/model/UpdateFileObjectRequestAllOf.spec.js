...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateFileObjectRequestAllOf();
  });
  ...
  describe('UpdateFileObjectRequestAllOf', function() {
    it('should create an instance of UpdateFileObjectRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateFileObjectRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateFileObjectRequestAllOf);
    });

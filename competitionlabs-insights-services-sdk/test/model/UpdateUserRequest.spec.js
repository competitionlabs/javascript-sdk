...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateUserRequest();
  });
  ...
  describe('UpdateUserRequest', function() {
    it('should create an instance of UpdateUserRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateUserRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateUserRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateCustomFieldRequestAllOf();
  });
  ...
  describe('UpdateCustomFieldRequestAllOf', function() {
    it('should create an instance of UpdateCustomFieldRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateCustomFieldRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateCustomFieldRequestAllOf);
    });

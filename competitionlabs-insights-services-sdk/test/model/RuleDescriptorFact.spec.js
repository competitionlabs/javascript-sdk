...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.RuleDescriptorFact();
  });
  ...
  describe('RuleDescriptorFact', function() {
    it('should create an instance of RuleDescriptorFact', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.RuleDescriptorFact();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.RuleDescriptorFact);
    });

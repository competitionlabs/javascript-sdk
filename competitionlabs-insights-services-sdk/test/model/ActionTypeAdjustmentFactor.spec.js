...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.ActionTypeAdjustmentFactor();
  });
  ...
  describe('ActionTypeAdjustmentFactor', function() {
    it('should create an instance of ActionTypeAdjustmentFactor', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.ActionTypeAdjustmentFactor();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.ActionTypeAdjustmentFactor);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateCompetitionRequest();
  });
  ...
  describe('UpdateCompetitionRequest', function() {
    it('should create an instance of UpdateCompetitionRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateCompetitionRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateCompetitionRequest);
    });

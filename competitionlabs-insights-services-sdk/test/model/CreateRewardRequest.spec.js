...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateRewardRequest();
  });
  ...
  describe('CreateRewardRequest', function() {
    it('should create an instance of CreateRewardRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateRewardRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateRewardRequest);
    });

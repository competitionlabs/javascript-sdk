...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateCompetitionStatusRequest();
  });
  ...
  describe('UpdateCompetitionStatusRequest', function() {
    it('should create an instance of UpdateCompetitionStatusRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateCompetitionStatusRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateCompetitionStatusRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.ClaimAwardRequest();
  });
  ...
  describe('ClaimAwardRequest', function() {
    it('should create an instance of ClaimAwardRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.ClaimAwardRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.ClaimAwardRequest);
    });

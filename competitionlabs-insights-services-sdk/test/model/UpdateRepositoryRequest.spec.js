...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateRepositoryRequest();
  });
  ...
  describe('UpdateRepositoryRequest', function() {
    it('should create an instance of UpdateRepositoryRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateRepositoryRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateRepositoryRequest);
    });

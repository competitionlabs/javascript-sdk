...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.WebhookAllOf();
  });
  ...
  describe('WebhookAllOf', function() {
    it('should create an instance of WebhookAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.WebhookAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.WebhookAllOf);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateRabbitMqConnectionRequest();
  });
  ...
  describe('CreateRabbitMqConnectionRequest', function() {
    it('should create an instance of CreateRabbitMqConnectionRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateRabbitMqConnectionRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateRabbitMqConnectionRequest);
    });

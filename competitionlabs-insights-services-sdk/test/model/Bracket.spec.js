...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Bracket();
  });
  ...
  describe('Bracket', function() {
    it('should create an instance of Bracket', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Bracket();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Bracket);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateContestStateRequest();
  });
  ...
  describe('UpdateContestStateRequest', function() {
    it('should create an instance of UpdateContestStateRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateContestStateRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateContestStateRequest);
    });

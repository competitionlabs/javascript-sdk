...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.QuerySingle();
  });
  ...
  describe('QuerySingle', function() {
    it('should create an instance of QuerySingle', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.QuerySingle();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.QuerySingle);
    });

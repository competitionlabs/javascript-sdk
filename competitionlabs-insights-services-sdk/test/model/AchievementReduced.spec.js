...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.AchievementReduced();
  });
  ...
  describe('AchievementReduced', function() {
    it('should create an instance of AchievementReduced', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.AchievementReduced();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.AchievementReduced);
    });

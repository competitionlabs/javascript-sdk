...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Macro();
  });
  ...
  describe('Macro', function() {
    it('should create an instance of Macro', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Macro();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Macro);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Contest();
  });
  ...
  describe('Contest', function() {
    it('should create an instance of Contest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Contest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Contest);
    });

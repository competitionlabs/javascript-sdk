...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateUserRequestAllOf();
  });
  ...
  describe('UpdateUserRequestAllOf', function() {
    it('should create an instance of UpdateUserRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateUserRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateUserRequestAllOf);
    });

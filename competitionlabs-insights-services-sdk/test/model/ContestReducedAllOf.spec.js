...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.ContestReducedAllOf();
  });
  ...
  describe('ContestReducedAllOf', function() {
    it('should create an instance of ContestReducedAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.ContestReducedAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.ContestReducedAllOf);
    });

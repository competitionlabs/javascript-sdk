...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.SpaceResponse();
  });
  ...
  describe('SpaceResponse', function() {
    it('should create an instance of SpaceResponse', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.SpaceResponse();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.SpaceResponse);
    });

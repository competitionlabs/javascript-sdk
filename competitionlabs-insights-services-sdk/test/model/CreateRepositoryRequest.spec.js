...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateRepositoryRequest();
  });
  ...
  describe('CreateRepositoryRequest', function() {
    it('should create an instance of CreateRepositoryRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateRepositoryRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateRepositoryRequest);
    });

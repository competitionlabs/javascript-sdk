...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.RabbitMqConnectionAllOf();
  });
  ...
  describe('RabbitMqConnectionAllOf', function() {
    it('should create an instance of RabbitMqConnectionAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.RabbitMqConnectionAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.RabbitMqConnectionAllOf);
    });

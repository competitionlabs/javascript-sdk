...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Relation();
  });
  ...
  describe('Relation', function() {
    it('should create an instance of Relation', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Relation();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Relation);
    });

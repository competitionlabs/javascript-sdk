...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Achievement();
  });
  ...
  describe('Achievement', function() {
    it('should create an instance of Achievement', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Achievement();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Achievement);
    });

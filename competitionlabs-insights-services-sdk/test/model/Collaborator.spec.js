...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Collaborator();
  });
  ...
  describe('Collaborator', function() {
    it('should create an instance of Collaborator', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Collaborator();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Collaborator);
    });

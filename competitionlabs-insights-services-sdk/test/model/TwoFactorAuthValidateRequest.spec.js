...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.TwoFactorAuthValidateRequest();
  });
  ...
  describe('TwoFactorAuthValidateRequest', function() {
    it('should create an instance of TwoFactorAuthValidateRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.TwoFactorAuthValidateRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.TwoFactorAuthValidateRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.RewardTypeAllOf();
  });
  ...
  describe('RewardTypeAllOf', function() {
    it('should create an instance of RewardTypeAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.RewardTypeAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.RewardTypeAllOf);
    });

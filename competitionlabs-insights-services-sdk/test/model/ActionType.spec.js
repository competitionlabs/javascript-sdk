...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.ActionType();
  });
  ...
  describe('ActionType', function() {
    it('should create an instance of ActionType', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.ActionType();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.ActionType);
    });

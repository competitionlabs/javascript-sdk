...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Event();
  });
  ...
  describe('Event', function() {
    it('should create an instance of Event', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Event();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Event);
    });

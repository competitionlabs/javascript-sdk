...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateMessageRequest();
  });
  ...
  describe('CreateMessageRequest', function() {
    it('should create an instance of CreateMessageRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateMessageRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateMessageRequest);
    });

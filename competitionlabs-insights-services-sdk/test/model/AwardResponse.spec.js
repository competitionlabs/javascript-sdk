...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.AwardResponse();
  });
  ...
  describe('AwardResponse', function() {
    it('should create an instance of AwardResponse', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.AwardResponse();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.AwardResponse);
    });

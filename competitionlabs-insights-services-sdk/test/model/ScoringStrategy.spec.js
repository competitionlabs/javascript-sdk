...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.ScoringStrategy();
  });
  ...
  describe('ScoringStrategy', function() {
    it('should create an instance of ScoringStrategy', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.ScoringStrategy();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.ScoringStrategy);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Rule();
  });
  ...
  describe('Rule', function() {
    it('should create an instance of Rule', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Rule();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Rule);
    });

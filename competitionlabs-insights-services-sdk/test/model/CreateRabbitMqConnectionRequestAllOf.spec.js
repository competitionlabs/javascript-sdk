...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateRabbitMqConnectionRequestAllOf();
  });
  ...
  describe('CreateRabbitMqConnectionRequestAllOf', function() {
    it('should create an instance of CreateRabbitMqConnectionRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateRabbitMqConnectionRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateRabbitMqConnectionRequestAllOf);
    });

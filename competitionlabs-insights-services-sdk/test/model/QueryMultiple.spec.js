...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.QueryMultiple();
  });
  ...
  describe('QueryMultiple', function() {
    it('should create an instance of QueryMultiple', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.QueryMultiple();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.QueryMultiple);
    });

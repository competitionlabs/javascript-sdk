...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.AchievementReducedAllOf();
  });
  ...
  describe('AchievementReducedAllOf', function() {
    it('should create an instance of AchievementReducedAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.AchievementReducedAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.AchievementReducedAllOf);
    });

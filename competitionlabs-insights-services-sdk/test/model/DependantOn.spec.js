...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.DependantOn();
  });
  ...
  describe('DependantOn', function() {
    it('should create an instance of DependantOn', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.DependantOn();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.DependantOn);
    });

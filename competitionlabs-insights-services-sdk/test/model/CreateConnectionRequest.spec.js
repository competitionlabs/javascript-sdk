...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateConnectionRequest();
  });
  ...
  describe('CreateConnectionRequest', function() {
    it('should create an instance of CreateConnectionRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateConnectionRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateConnectionRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateCompetitionStatusRequestAllOf();
  });
  ...
  describe('UpdateCompetitionStatusRequestAllOf', function() {
    it('should create an instance of UpdateCompetitionStatusRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateCompetitionStatusRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateCompetitionStatusRequestAllOf);
    });

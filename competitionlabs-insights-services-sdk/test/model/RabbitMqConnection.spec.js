...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.RabbitMqConnection();
  });
  ...
  describe('RabbitMqConnection', function() {
    it('should create an instance of RabbitMqConnection', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.RabbitMqConnection();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.RabbitMqConnection);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.ContestReduced();
  });
  ...
  describe('ContestReduced', function() {
    it('should create an instance of ContestReduced', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.ContestReduced();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.ContestReduced);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateCustomFieldRequest();
  });
  ...
  describe('UpdateCustomFieldRequest', function() {
    it('should create an instance of UpdateCustomFieldRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateCustomFieldRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateCustomFieldRequest);
    });

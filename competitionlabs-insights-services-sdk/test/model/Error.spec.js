...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Error();
  });
  ...
  describe('Error', function() {
    it('should create an instance of Error', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Error();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Error);
    });

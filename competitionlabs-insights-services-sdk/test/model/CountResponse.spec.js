...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CountResponse();
  });
  ...
  describe('CountResponse', function() {
    it('should create an instance of CountResponse', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CountResponse();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CountResponse);
    });

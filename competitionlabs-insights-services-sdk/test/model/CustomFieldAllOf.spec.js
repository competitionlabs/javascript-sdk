...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CustomFieldAllOf();
  });
  ...
  describe('CustomFieldAllOf', function() {
    it('should create an instance of CustomFieldAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CustomFieldAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CustomFieldAllOf);
    });

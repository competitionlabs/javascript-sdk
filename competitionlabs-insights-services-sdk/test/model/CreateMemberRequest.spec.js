...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateMemberRequest();
  });
  ...
  describe('CreateMemberRequest', function() {
    it('should create an instance of CreateMemberRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateMemberRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateMemberRequest);
    });

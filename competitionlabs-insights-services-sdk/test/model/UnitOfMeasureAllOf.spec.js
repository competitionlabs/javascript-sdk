...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UnitOfMeasureAllOf();
  });
  ...
  describe('UnitOfMeasureAllOf', function() {
    it('should create an instance of UnitOfMeasureAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UnitOfMeasureAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UnitOfMeasureAllOf);
    });

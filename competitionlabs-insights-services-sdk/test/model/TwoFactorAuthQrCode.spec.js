...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.TwoFactorAuthQrCode();
  });
  ...
  describe('TwoFactorAuthQrCode', function() {
    it('should create an instance of TwoFactorAuthQrCode', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.TwoFactorAuthQrCode();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.TwoFactorAuthQrCode);
    });

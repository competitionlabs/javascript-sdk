...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CompetitionAllOf();
  });
  ...
  describe('CompetitionAllOf', function() {
    it('should create an instance of CompetitionAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CompetitionAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CompetitionAllOf);
    });

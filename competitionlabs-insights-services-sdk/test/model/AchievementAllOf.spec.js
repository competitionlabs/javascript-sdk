...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.AchievementAllOf();
  });
  ...
  describe('AchievementAllOf', function() {
    it('should create an instance of AchievementAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.AchievementAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.AchievementAllOf);
    });

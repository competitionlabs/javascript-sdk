...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.ChangePasswordRequest();
  });
  ...
  describe('ChangePasswordRequest', function() {
    it('should create an instance of ChangePasswordRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.ChangePasswordRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.ChangePasswordRequest);
    });

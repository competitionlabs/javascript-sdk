...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CollaboratorAllOf();
  });
  ...
  describe('CollaboratorAllOf', function() {
    it('should create an instance of CollaboratorAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CollaboratorAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CollaboratorAllOf);
    });

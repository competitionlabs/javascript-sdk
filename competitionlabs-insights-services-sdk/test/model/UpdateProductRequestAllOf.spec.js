...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateProductRequestAllOf();
  });
  ...
  describe('UpdateProductRequestAllOf', function() {
    it('should create an instance of UpdateProductRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateProductRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateProductRequestAllOf);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.ProductReducedAllOf();
  });
  ...
  describe('ProductReducedAllOf', function() {
    it('should create an instance of ProductReducedAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.ProductReducedAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.ProductReducedAllOf);
    });

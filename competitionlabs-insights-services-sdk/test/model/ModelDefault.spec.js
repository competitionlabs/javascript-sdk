...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.ModelDefault();
  });
  ...
  describe('ModelDefault', function() {
    it('should create an instance of ModelDefault', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.ModelDefault();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.ModelDefault);
    });

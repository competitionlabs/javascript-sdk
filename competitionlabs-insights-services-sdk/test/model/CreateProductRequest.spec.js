...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateProductRequest();
  });
  ...
  describe('CreateProductRequest', function() {
    it('should create an instance of CreateProductRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateProductRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateProductRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateKafkaConnectionRequestAllOf();
  });
  ...
  describe('CreateKafkaConnectionRequestAllOf', function() {
    it('should create an instance of CreateKafkaConnectionRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateKafkaConnectionRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateKafkaConnectionRequestAllOf);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Product();
  });
  ...
  describe('Product', function() {
    it('should create an instance of Product', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Product();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Product);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.RuleDescriptor();
  });
  ...
  describe('RuleDescriptor', function() {
    it('should create an instance of RuleDescriptor', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.RuleDescriptor();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.RuleDescriptor);
    });

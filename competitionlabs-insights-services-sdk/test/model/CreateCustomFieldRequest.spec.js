...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateCustomFieldRequest();
  });
  ...
  describe('CreateCustomFieldRequest', function() {
    it('should create an instance of CreateCustomFieldRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateCustomFieldRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateCustomFieldRequest);
    });

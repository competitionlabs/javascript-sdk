...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.OnRuleSetMatchTrigger();
  });
  ...
  describe('OnRuleSetMatchTrigger', function() {
    it('should create an instance of OnRuleSetMatchTrigger', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.OnRuleSetMatchTrigger();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.OnRuleSetMatchTrigger);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateLanguageRequest();
  });
  ...
  describe('UpdateLanguageRequest', function() {
    it('should create an instance of UpdateLanguageRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateLanguageRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateLanguageRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.MemberAchievementCount();
  });
  ...
  describe('MemberAchievementCount', function() {
    it('should create an instance of MemberAchievementCount', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.MemberAchievementCount();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.MemberAchievementCount);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateCompetitionRequest();
  });
  ...
  describe('CreateCompetitionRequest', function() {
    it('should create an instance of CreateCompetitionRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateCompetitionRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateCompetitionRequest);
    });

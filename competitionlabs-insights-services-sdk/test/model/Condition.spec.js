...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Condition();
  });
  ...
  describe('Condition', function() {
    it('should create an instance of Condition', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Condition();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Condition);
    });

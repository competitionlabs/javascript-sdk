...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateContestRequest();
  });
  ...
  describe('UpdateContestRequest', function() {
    it('should create an instance of UpdateContestRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateContestRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateContestRequest);
    });

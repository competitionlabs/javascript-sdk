...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.MetaInfo();
  });
  ...
  describe('MetaInfo', function() {
    it('should create an instance of MetaInfo', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.MetaInfo();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.MetaInfo);
    });

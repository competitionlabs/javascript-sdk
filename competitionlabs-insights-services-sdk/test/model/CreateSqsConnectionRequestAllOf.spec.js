...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateSqsConnectionRequestAllOf();
  });
  ...
  describe('CreateSqsConnectionRequestAllOf', function() {
    it('should create an instance of CreateSqsConnectionRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateSqsConnectionRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateSqsConnectionRequestAllOf);
    });

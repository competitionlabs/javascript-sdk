...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.FactDefault();
  });
  ...
  describe('FactDefault', function() {
    it('should create an instance of FactDefault', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.FactDefault();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.FactDefault);
    });

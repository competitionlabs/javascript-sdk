...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.QueryRequest();
  });
  ...
  describe('QueryRequest', function() {
    it('should create an instance of QueryRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.QueryRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.QueryRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateFileObjectFormRequest();
  });
  ...
  describe('UpdateFileObjectFormRequest', function() {
    it('should create an instance of UpdateFileObjectFormRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateFileObjectFormRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateFileObjectFormRequest);
    });

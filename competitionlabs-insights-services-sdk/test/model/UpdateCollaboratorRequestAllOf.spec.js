...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateCollaboratorRequestAllOf();
  });
  ...
  describe('UpdateCollaboratorRequestAllOf', function() {
    it('should create an instance of UpdateCollaboratorRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateCollaboratorRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateCollaboratorRequestAllOf);
    });

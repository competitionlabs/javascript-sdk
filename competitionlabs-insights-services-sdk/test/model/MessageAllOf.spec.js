...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.MessageAllOf();
  });
  ...
  describe('MessageAllOf', function() {
    it('should create an instance of MessageAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.MessageAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.MessageAllOf);
    });

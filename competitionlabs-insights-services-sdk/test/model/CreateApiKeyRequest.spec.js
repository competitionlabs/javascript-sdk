...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateApiKeyRequest();
  });
  ...
  describe('CreateApiKeyRequest', function() {
    it('should create an instance of CreateApiKeyRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateApiKeyRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateApiKeyRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.AchievementIssuedCount();
  });
  ...
  describe('AchievementIssuedCount', function() {
    it('should create an instance of AchievementIssuedCount', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.AchievementIssuedCount();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.AchievementIssuedCount);
    });

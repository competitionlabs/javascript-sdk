...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.MaxMin();
  });
  ...
  describe('MaxMin', function() {
    it('should create an instance of MaxMin', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.MaxMin();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.MaxMin);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateCompetitionRequestAllOf();
  });
  ...
  describe('UpdateCompetitionRequestAllOf', function() {
    it('should create an instance of UpdateCompetitionRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateCompetitionRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateCompetitionRequestAllOf);
    });

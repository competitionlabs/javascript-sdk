...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.MemberAward();
  });
  ...
  describe('MemberAward', function() {
    it('should create an instance of MemberAward', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.MemberAward();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.MemberAward);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.ContactAllOf();
  });
  ...
  describe('ContactAllOf', function() {
    it('should create an instance of ContactAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.ContactAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.ContactAllOf);
    });

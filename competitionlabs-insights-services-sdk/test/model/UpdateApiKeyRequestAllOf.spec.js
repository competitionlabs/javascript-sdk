...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateApiKeyRequestAllOf();
  });
  ...
  describe('UpdateApiKeyRequestAllOf', function() {
    it('should create an instance of UpdateApiKeyRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateApiKeyRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateApiKeyRequestAllOf);
    });

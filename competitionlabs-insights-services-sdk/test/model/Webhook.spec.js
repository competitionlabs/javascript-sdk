...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Webhook();
  });
  ...
  describe('Webhook', function() {
    it('should create an instance of Webhook', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Webhook();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Webhook);
    });

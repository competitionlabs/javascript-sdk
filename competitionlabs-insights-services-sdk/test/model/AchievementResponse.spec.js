...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.AchievementResponse();
  });
  ...
  describe('AchievementResponse', function() {
    it('should create an instance of AchievementResponse', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.AchievementResponse();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.AchievementResponse);
    });

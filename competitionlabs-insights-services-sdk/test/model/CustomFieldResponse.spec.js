...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CustomFieldResponse();
  });
  ...
  describe('CustomFieldResponse', function() {
    it('should create an instance of CustomFieldResponse', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CustomFieldResponse();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CustomFieldResponse);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.RewardAllOf();
  });
  ...
  describe('RewardAllOf', function() {
    it('should create an instance of RewardAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.RewardAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.RewardAllOf);
    });

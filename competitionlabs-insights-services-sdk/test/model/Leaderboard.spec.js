...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Leaderboard();
  });
  ...
  describe('Leaderboard', function() {
    it('should create an instance of Leaderboard', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Leaderboard();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Leaderboard);
    });

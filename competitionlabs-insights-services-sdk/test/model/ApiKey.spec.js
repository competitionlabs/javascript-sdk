...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.ApiKey();
  });
  ...
  describe('ApiKey', function() {
    it('should create an instance of ApiKey', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.ApiKey();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.ApiKey);
    });

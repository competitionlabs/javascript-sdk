...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateUnitOfMeasureRequestAllOf();
  });
  ...
  describe('UpdateUnitOfMeasureRequestAllOf', function() {
    it('should create an instance of UpdateUnitOfMeasureRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateUnitOfMeasureRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateUnitOfMeasureRequestAllOf);
    });

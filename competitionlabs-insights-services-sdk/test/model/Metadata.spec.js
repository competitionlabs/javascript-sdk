...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Metadata();
  });
  ...
  describe('Metadata', function() {
    it('should create an instance of Metadata', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Metadata();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Metadata);
    });

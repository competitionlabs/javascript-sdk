...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.AchievementLiveStatusRequestAllOf();
  });
  ...
  describe('AchievementLiveStatusRequestAllOf', function() {
    it('should create an instance of AchievementLiveStatusRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.AchievementLiveStatusRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.AchievementLiveStatusRequestAllOf);
    });

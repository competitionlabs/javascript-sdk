...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Attachment();
  });
  ...
  describe('Attachment', function() {
    it('should create an instance of Attachment', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Attachment();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Attachment);
    });

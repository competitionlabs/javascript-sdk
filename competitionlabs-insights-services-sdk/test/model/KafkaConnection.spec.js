...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.KafkaConnection();
  });
  ...
  describe('KafkaConnection', function() {
    it('should create an instance of KafkaConnection', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.KafkaConnection();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.KafkaConnection);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateWebhookRequest();
  });
  ...
  describe('UpdateWebhookRequest', function() {
    it('should create an instance of UpdateWebhookRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateWebhookRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateWebhookRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.MemberAchievementCountAllOf();
  });
  ...
  describe('MemberAchievementCountAllOf', function() {
    it('should create an instance of MemberAchievementCountAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.MemberAchievementCountAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.MemberAchievementCountAllOf);
    });

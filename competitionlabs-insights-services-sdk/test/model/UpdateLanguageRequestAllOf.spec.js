...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateLanguageRequestAllOf();
  });
  ...
  describe('UpdateLanguageRequestAllOf', function() {
    it('should create an instance of UpdateLanguageRequestAllOf', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateLanguageRequestAllOf();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateLanguageRequestAllOf);
    });

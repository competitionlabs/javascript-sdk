...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.Translation();
  });
  ...
  describe('Translation', function() {
    it('should create an instance of Translation', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.Translation();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.Translation);
    });

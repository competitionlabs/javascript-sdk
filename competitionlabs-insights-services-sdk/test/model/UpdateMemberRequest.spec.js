...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.UpdateMemberRequest();
  });
  ...
  describe('UpdateMemberRequest', function() {
    it('should create an instance of UpdateMemberRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.UpdateMemberRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.UpdateMemberRequest);
    });

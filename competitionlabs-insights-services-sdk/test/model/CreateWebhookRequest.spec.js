...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateWebhookRequest();
  });
  ...
  describe('CreateWebhookRequest', function() {
    it('should create an instance of CreateWebhookRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateWebhookRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateWebhookRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @CompetitionlabsInsightsServicesSdk.CreateLanguageRequest();
  });
  ...
  describe('CreateLanguageRequest', function() {
    it('should create an instance of CreateLanguageRequest', function() {
      ...
      //var instane = new @CompetitionlabsInsightsServicesSdk.CreateLanguageRequest();
      //expect(instance).to.be.a(@CompetitionlabsInsightsServicesSdk.CreateLanguageRequest);
    });
